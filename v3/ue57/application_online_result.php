...
<head>
  ...
  <link rel="stylesheet" href="./assets/css/event_start25.css">
  <link rel="stylesheet" href="./assets/css/font_start25.css">
...
<body>
  <header class="header">
    <div class="inner-wrap">
      <div class="logo">
<a href="https://epiclounge.co.kr/start_lsu2025.php"><span class="blind">로고</span></a>
      </div>
      <div class="confirm">
        <p>이미 등록을 하셨나요?</p>
        <div class="btn-group">
  ...
  <div class="container">
      ...
      <div class="event-header">
        <img src="https://unrealsummit16.cafe24.com/2025/start_twinunreal/top_logo25.svg" alt="시작해요 언리얼" class="event-logo" />
      </div>
        ...
        <div class="content-box">
			...
			<div class="result_text_box">
                <p>일시: 4월23일 ~ 5월28일, 매주 수요일 오후 2시</p>
                <p>채널: 에픽 라운지</p>
            </div>
            <p class="result_text_3">*행사 종료 시간은 날짜별로 상이할 수 있습니다.</p>
      
            <div class="result_text_box2 free_box">
                <div class="result_text_box2_wrap">
                    <h3><strong>안내</strong></h3>
                    <ul>
						<li>행사 당일에 카카오톡(or 문자)/이메일로 접속 링크가 발송됩니다. </li>
						<li>접속 링크를 받지 못하더라도 에픽 라운지에서 등록 확인 후 시청하실 수 있습니다.</li>
        ...
        <div class="btn-group">
          <a href="https://epiclounge.co.kr/start_lsu2025.php"  class="btn-next">확인</a>
        </div>
    </div>
  </div>
