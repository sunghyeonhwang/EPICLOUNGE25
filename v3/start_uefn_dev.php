...
<?php
  ...
  <!-- container -->
    ...
    <div class="wrap">
      ...
      <a href="https://youtube.com/live/5U5ubA15lsE?feature=share" class="visual_anchor" target="_blank">1주차 | 유튜브 알림 설정하기</a>
    ...
    <div class="wrap">
      ...
      <h3>상상해왔던 자신만의 게임을 손쉽게 만들어 싶으신가요?</h3>
      <p>
...
라이브 Q&A와 채팅을 통해 더욱 인터랙티브한 학습 환경을 제공합니다.
    ...
    <div class="wrap">
      ...
      <ul class="curr_list">
      <li class="curr_item con" id="one">
        <div class="curr_item_title">
        <h3>
          <div class="title"><a href="https://youtube.com/live/5U5ubA15lsE?feature=share" target="_blank">1주차&nbsp;&nbsp;|&nbsp;&nbsp;동전 수집 게임 제작하기</a></div>
          <span class="status"><a href="https://youtube.com/live/5U5ubA15lsE?feature=share" target="_blank">2023.06.15 (목)</a></span>
        </h3>
        </div>
      ...
      <li class="curr_item con" id="two">
        ...
        <h3>
          <div class="title"><a href="https://youtube.com/live/bDMGA2xha0U?feature=share" target="_blank">2주차&nbsp;&nbsp;|&nbsp;&nbsp;데스런 형태의 동전 수집 게임 제작하기</a></div>
          <span class="status"><a href="https://youtube.com/live/bDMGA2xha0U?feature=share" target="_blank">2023.06.22 (목)</a></span>
        </h3>
        </div>
        <div class="curr_item_con" ">
      ...
      <li class="curr_item con" id="three">
        ...
        <h3>
          <div class="title"><a href="https://youtube.com/live/CXKzX5NCC88?feature=share" target="_blank">3주차&nbsp;&nbsp;|&nbsp;&nbspPvE 게임 제작하기</a></div>
          <span class="status"><a href="https://youtube.com/live/CXKzX5NCC88?feature=share" target="_blank">2023.06.29 (목)</a></span>
        </h3>
        </div>
        <div class="curr_item_con">
     ...
     <!-- <li class="curr_item replay">
      ...
      <div class="btn_wrap">
      <a href="https://youtube.com/live/5U5ubA15lsE?feature=share"  target="_blank" class="btn">1주차 | 유튜브 알림 설정하기</a>
      </div>
    </div>
    </section>
    ...
    <div class="wrap">
      ...
      <li class="event_item item1">
       ...
       <li class="event_detail_item">
        ...
        <div class="event_img">
        <img src="https://unrealsummit16.cafe24.com/2023/start_uefn/event1v.png" alt="" />
        </div>
      </li>
      <li class="event_item item2">
        ...
        <div class="sub_text">매주 웨비나 중 출제되는 도전과제를 출제자의 의도에 맞게 성실히 <em>수행하신 분들 중 20분을 추첨</em>해 언리얼 엔진 굿즈를 드립니다.</div>
        </div><br>
        <ul class="event_detail_list">
        <li class="event_detail_item">
          <span class="title">참여 기간</span>
    ...
    <div class="wrap">
      ...
      <ul class="faq_list">
        ...
        <div class="a" title="열림">
          총 2가지를 준비해 주세요.<br />
          1.<span><a href="https://store.epicgames.com/" target="_blank"> 에픽게임즈 스토어</a> </span> 홈페이지에서 에픽 계정을 생성 후 <span><a href="https://www.unrealengine.com/ko/download" target="_blank">에픽게임즈 런처</a></span>를 설치해 주세요. <br />
        ...
        <div class="a" title="열림"><span><a href="https://youtube.com/live/5U5ubA15lsE?feature=share" target="_blank">유튜브 알림을 설정</a></span>해 놓으면 본 웨비나를 시간에 맞춰 시청하실 수 있습니다.</div>
        <button type="button" class="more_btn" data-open="false" title="닫힘">닫힘</button>
        </li>
        <li class="faq_item">
        <div class="q">
          <span class="q_title">웨비나는 어떻게 시청하요?</span>
        </div>
        <div class="a" title="열림">
