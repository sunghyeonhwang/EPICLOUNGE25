        ...
        <div class="wrap">
            ...
            <div class="program_wrap">
                ...
                <div class="program_content">
                    ...
                    <article class="program program2">
                        <button type="button" data-btn-pop="" class="program_part part1" data-category="애니메이션,비주얼아트,기획/프로덕션,극장, IPTV,중급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
                                    <span class="num">3</span>
                ...
                <div class="program_content">
                    ...
                    <article class="program program2">
                        <button type="button" data-btn-pop="" class="program_part part1" data-category="건축, 제조 & 시뮬레이션,서비스,XR/VR/AR/MR,디지털 트윈,PC,모바일,MS Hololens,초급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
                                    <span class="num">3</span>
