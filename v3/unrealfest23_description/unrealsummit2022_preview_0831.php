    ...
    <section class="schedule" data-page-index="3">
        <div class="wrap">
            ...
            <div class="program_wrap">
                <div class="program_content">
                    ...
                    <article class="program program1">
                        <button type="button" data-btn-pop="" class="program_part part1">
                            <span class="img_wrap">
                    ...
                    <article class="program program2">
                        <button type="button" data-btn-pop="pop_3" class="program_part part1">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
                        ...
                        <button type="button" data-btn-pop="pop_4" class="program_part part2">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
                    ...
                    <article class="program program3">
                        <button type="button" data-btn-pop="pop_5" class="program_part part1">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
                        ...
                        <button type="button" data-btn-pop="pop_6" class="program_part part2">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
            ...
            <div class="schedule_bottom">
                ...
                <div class="program_content">
                    <article class="program program1">
                        <button type="button" data-btn-pop="pop_7" class="program_part part1">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
                                    <span class="num">1</span>
                        ...
                        <button type="button" data-btn-pop="pop_8" class="program_part part2">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
                                    <span class="num">2</span>
                    ...
                    <article class="program program2">
                        <button type="button" data-btn-pop="pop_9" class="program_part part1">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
                                    <span class="num">3</span>
                        ...
                        <button type="button" data-btn-pop="pop_10" class="program_part part2">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
                                    <span class="num">4</span>
                    ...
                    <article class="program program4">
                        <button type="button" data-btn-pop="pop_11" class="program_part part1">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(/v3/resource_0829/images/main/session_bg.jpg)"></span>
                                <span class="title">
                                    <span class="num">5</span>
                    ...
                    <article class="program program2">
                        ...
                        <button type="button" data-btn-pop="pop" class="program_part part2">
                            ...
                            <span class="program_con">
                                ...
                                <span class="owner">유영빈, 비브스튜디오</span>
                            </span>
                        </button>
                    </article>
                    <article class="program program3">
