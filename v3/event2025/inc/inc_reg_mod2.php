    ...
    <div class="login-box">
      ...
      <div class="b-con">
        <form id="registration-form" name="registration-form" method="post" onsubmit="return false;">
          <input type="hidden" id="inputApplyNo" name="inputApplyNo">
          <input type="hidden" id="inputEmail" name="inputEmail">
          <p class="p-title staricon">등록정보 수정</p>
          <ul>
            <li>
              <input type="text" placeholder="이름" id="inputName" name="inputName" value="<?= IS_TEST ? '테스터' : '' ?>">
            </li>
            <li>
              <input type="text" placeholder="휴대폰 번호" id="inputPhone" name="inputPhone" value="<?= IS_TEST ? '01027771701' : '' ?>">
            </li>
          </ul><br>
          <p>&nbsp;</p>
          ...
          <p>&nbsp;</p>
          <p class="s-title">선택정보</p>
          <ul>
            <li>
              <input type="text" placeholder="언리얼 엔진 계정(이메일)을 입력해 주세요" id="inputEx3" name="inputEx3" value="">
            </li>
          </ul>
        <p>&nbsp;</p>
          <p class="s-title">홍보성 알림 수신 동의서</p>
          <textarea name="agreeInfo" cols="30" rows="10">
에픽 라운지는 마케팅 또는 홍보자료 배포를 위하여 다음과 같이 개인정보를 수집 및 이용합니다. 귀하는 개인정보의 수집 및 이용에 대한 동의를 거부할 수 있으나 거부시 에픽 라운지로부터 유용한 정보를 제공받지 못할 수 있습니다.
...
에픽 라운지 개인정보보호정책에 따름</textarea>
          ...
          <div class="login-btn">
            <a href="javascript:;" id="btnRegist">등록수정</a>
          </div>
          <br>
          <div class="login-btn">
            <a href="javascript:;" class="gray-btn" id="btnCancel">등록취소</a>
          </div>
