<div class="live-training">
  <div class="boxy-warp">
    <div class="t-logo">
      ...
      <a id="idQnaLink" href="javascript:;">라이브 Q&A용 질문하기</a>
    </div>
    <div class="video-chat-box">
      ...
      <div class="r-chat">
        <div class="chat-box">
          <iframe id="cgchat" name="cgchat" src="<?=$SEL_DATA['chat_link']?>" style="width:100%;height:518px;margin:0;padding:0;border:solid 1px #dddddd;"></iframe>
        </div>
      </div>
    </div>
    <div class="b-btn2">
