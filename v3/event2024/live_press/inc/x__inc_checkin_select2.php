  ...
  <div class="boxy-warp">
    ...
    <div class="check-box">
      ...
      <ul>
        ...
        <li>
        <!--<div class="txtc"> 현재 진행 세션 노출 </p>-->
        <div class="e-btn hover1">
        <a href="#" id="" data-toggle="modal" >트랙 1 : 자동차&건축</a>
        </div>
        </li>
        <li>
          <div style="height:10px;"></div>
		...
		<li>	
        <div class="f-btn hover1"> 
	    <a href="#" id="" data-toggle="modal" >트랙 2 : M&E</a>
		</div>
        </li>
        <li>
          <div style="height:10px;"></div>
