            ...
            <li class="curr_item item1">
              <div class="curr_item_title">
                <h3>
                  ...
                  <span class="status date">2023.03.14</span>
                </h3>
              </div>
            ...
            <li class="curr_item2">
              <div class="curr_item_title">
                <h3>
                  ...
                  <span class="status date">2023.03.21</span>
                </h3>
              </div>
              <div class="curr_item_con">
            ...
            <li class="curr_item3">
              <div class="curr_item_title">
                <h3>
                  ...
                  <span class="status date">2023.03.28</span>
                </h3>
              </div>
              <div class="curr_item_con">
            ...
            <ul class="ready_list">
              ...
              <li class="ready_item">
                ...
                <div class="ready_con">
                  ...
                  <p>참석 전 <span><a href="https://www.unrealengine.com/ko/download" target="_blank">언리얼 엔진을 설치</a></span>하면 따라해보면서 시청할 수 있습니다.</p>
                </div>
              </li>
              <!-- 임시주석 
				      <li class="ready_item">
        ...
        <div class="wrap">
          ...
          <ul class="event_list">
            <li class="event_item item1">
              ...
              <div class="event_img">
                <img src="https://unrealsummit16.cafe24.com/start23_R_image/event1.png" alt="" />
              </div>
            </li>
            <li class="event_item item2">
              ...
              <div class="event_img">
                <img src="https://unrealsummit16.cafe24.com/start23_R_image/event2.png" alt="" />
              </div>
            </li>
          </ul>
            ...
            <ul class="faq_list">
              <li class="faq_item">
                ...
                <div class="a" title="열림">
                  ...
                  2. <span><a href="https://www.unrealengine.com/ko/download" target="_blank">언리얼 엔진을 설치</a></span>해 주세요. 참석 전 언리얼 엔진을 설치하면 따라 해 보면서 시청할 수 있습니다.<br />
