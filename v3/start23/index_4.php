          ...
          <ul class="curr_list">
            <li class="curr_item onair">
              <div class="curr_item_title">
                <h3>
                  <div class="title"><a href="https://link.epiclounge.co.kr/3NTPZRU" target="_blank">1주차&nbsp;&nbsp;|&nbsp;&nbsp;레벨 제작 준비하기</a></div>
                  <span class="status"><a href="https://link.epiclounge.co.kr/3NTPZRU" target="_blank">ON AIR</a></span>
                </h3>
              </div>
        ...
        <div class="wrap">
          ...
          <div class="con_wrap">
            <ul class="ready_list">
              ...
              <!-- 임시주석 
              <li class="ready_item">
                <div class="img"<a href="https://youtu.be/c4vPCPKkMRE" target="_blank"><img src="https://unrealsummit16.cafe24.com/site/assets/start23/ready3.png" alt="" /></a></div>
                <div class="ready_con">
                  <h3>3. 에셋을 다운로드해 주세요.</h3>
                  <p>강연에서 사용하는 에셋을 <span>다운로드</span>하면 끊김없이 강연에 집중할 수 있습니다.</p>
                </div>
              </li> -->
            </ul>
          </div>
