        ...
        <div class="wrap">
          ...
          <div class="video">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/vuEuN2Ir06s?amp;autoplay=1&&amp;mute=1&amp;playlist=vuEuN2Ir06s&amp;loop=1&amp;mute=1"    
        ...
        <div class="wrap">
          ...
          <ul class="target_list">
            ...
            <li class="target_item item3">
              ...
              <div class="con">5회 강좌로 <br />고퀄리티 시네마틱 영상을 만들고 싶으신 분</div>
            </li>
          </ul>
        </div>
      </section>
          ...
          <ul class="event_list">
            ...
            <li class="event_item item2">
              <div class="event_item_title">
                ...
                <div class="sub_text">매주 웨비나 중 출제되는 도전과제를 출제자의 의도에 맞게 성실히 수행하신 분들 중중 30분을 추첨해 언리얼 굿즈를 드립니다.</div>
              </div>
              <ul class="event_detail_list">
                <li class="event_detail_item">
                  <span class="title">참여 기간</span>
            ...
            <ul class="faq_list">
              <li class="faq_item active">
                ...
                <div class="a" title="열림">
                  ...
                  2. <span><a href="https://youtu.be/nO1baR47bYE" target="_blank">언리얼 엔진을 설치</a></span>해 주세요. 참석 전 언리얼 엔진을 설치하면 따라 해 보면서 시청할 수 있습니다.<br />
