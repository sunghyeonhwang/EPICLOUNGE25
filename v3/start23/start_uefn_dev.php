...
<?php include '../inc/common_header.php'; ?>
  <!-- container -->
    ...
    <div class="wrap">
      ...
      <h3>
        <img src="https://unrealsummit16.cafe24.com/start23_R_image/visual_text23.svg" alt="시작해요 UEFN" />
      </h3>
    ...
    <div class="wrap">
      ...
      <p>
      시작해요 UEFN은 언리얼 엔진 초심자를 위한 튜토리얼 형식의 웨비나입니다. 아트 콘셉트 디자인부터 레벨 제작 및 디테일, 라이팅 세팅, 그리고 시퀀서를 통한 영상 연출과 렌더링까지 언리얼
    ...
    <div class="wrap">
      ...
      <li class="event_item item1">
        ...
        <div class="sub_text">시작해요 UEFN 매주 웨비나를 처음부터 끝까지 시청하신 분들 중 50분을 추첨해 언리얼 엔진 굿즈를 드립니다.</div>
        </div>
    ...
    <div class="wrap">
      ...
      <ul class="faq_list">
        ...
        <li class="faq_item">
        <div class="q">
          <span class="q_title">시작해요 UEFN은 어떻게 시청하나요?</span>
        </div>
        <div class="a" title="열림">
