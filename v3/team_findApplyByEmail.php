...
$message = '<언리얼 페스트 2023 서울>\n단체 등록이 완료 되었습니다.\n 등록 리스트 확인 후 입력정보가 상이할시 등록이 취소되며, 입장이 불가능 할 수 있습니다.\n\n일시: 8월29일(화)~9월1일(금) 10:30~\n채널: 에픽 라운지\n\n-28일 오후에 카카오톡(or 문자)/이메일로 QR코드가 발송됩니다. \n-접속 링크를 받지 못하더라도 입구 등록 데스크에서 등록 확인 후 입장 가능합니다..\n\n- 에픽 라운지 사무국';             //필수입력
...
//문자 발송 종료
  ...
  echo '<script type="text/javascript">';
  echo "location.replace('https://epiclounge.co.kr/v3/team_application_online_result.php');";
  echo '</script>';
  exit();
