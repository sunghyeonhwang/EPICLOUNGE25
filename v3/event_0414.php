...
아래의 관심 분야별 학습 리소스로 창작의 여정을 시작해 보세요! </p>
		...
		<div class="tab_button">
				...
				<div class="list_box_wrap">
					...
					<div class="list_box">
						<a href="https://dev.epicgames.com/community/learning/talks-and-demos/6GGK/the-matrix-awakens-generating-a-world" title="새창" target="_blank">
							<span class="img"><img src="/v3/resource/images/event/event_tab_1_3.jpg" /></span>
							<span class="text">The Matrix Awakens: Generating A World</span>
						</a>
					</div>
					<div class="list_box">
						<a href="https://dev.epicgames.com/community/learning/talks-and-demos/vyn9/unreal-engine-5-guided-tour" title="새창" target="_blank">
							<span class="img"><img src="/v3/resource/images/event/event_tab_1_4.jpg" /></span>
							<span class="text">Unreal Engine 5 Guided Tour</span>
						</a>
					</div>
				</div>
			...
			<div class="tab_content tab2">
				<div class="list_box_wrap">
					<div class="list_box">
						<a href="https://dev.epicgames.com/community/learning/paths/Z4/lyra-starter-game" title="새창" target="_blank">
							...
							<span class="text">Lyra Starter Game</span>
						</a>
					</div>
					<div class="list_box">
						<a href="https://dev.epicgames.com/community/learning/talks-and-demos/J5q/upgrading-your-project-to-ue5" title="새창" target="_blank">
							<span class="img"><img src="/v3/resource/images/event/event_tab_2_2.jpg" /></span>
							<span class="text">Upgrading Your Project To UE5</span>
						</a>
					</div>
					<div class="list_box">
				...
				<div class="all_btn"><a href="https://www.unrealengine.com/ko/solutions/games" title="새창" target="_blank">게임 콘텐츠 전체보기</a></div>
			</div>
			<div class="tab_content tab3">
				<div class="list_box_wrap">
					...
					<div class="list_box">
						<a href="https://www.unrealengine.com/ko/solutions/film-television" title="새창" target="_blank">
							<span class="img"><img src="/v3/resource/images/event/event_tab_3_4.jpg" /></span>
							<span class="text">콘텐츠 전체보기</span>
						</a>
					</div>
				</div>
				<div class="all_btn"><a href="https://www.unrealengine.com/ko/solutions/film-television" title="새창" target="_blank">영화 & TV 콘텐츠 전체보기</a></div>
			</div>
			...
			<div class="tab_content tab4">
				...
				<div class="all_btn"><a href="https://www.unrealengine.com/ko/solutions/architecture" title="새창" target="_blank">건축 콘텐츠 전체보기</a></div>
			</div>
			...
			<div class="tab_content tab5">
				...
				<div class="all_btn"><a href="https://www.unrealengine.com/ko/solutions/more-uses" title="새창" target="_blank">기타 콘텐츠 전체보기</a></div>
			</div>
	...
	<div class="wrap">
		<div class="sec_2_top">
			<div class="sec_2_top_left">
				...
				<ul>
					...
					<li>
						...
						<span class="text_box">
							<span class="title">도시 샘플 빌딩</span>
					...
					<li>
						...
						<span class="text_box">
							<span class="title">도시 샘플 비히클</span>
				...
				<a href="https://www.unrealengine.com/marketplace/ko/profile/Epic+Games?count=20&sortBy=effectiveDate&sortDir=DESC&start=0" class="sec_2_top_left_btn" title="새창" target="_blank">UE5 에셋 더보기</a>
			</div>
			<div class="sec_2_top_right">
				...
				<a href="#n" class="sec_2_top_right_btn" title="새창" target="_blank">언리얼 엔진 문서 방문하기</a>
		...
		<div class="sec_2_mid">
			...
			<div class="list">
				<div class="list_box">
					...
					<a href="#n" title="새창" target="_blank">방문하기</a>
				</div>
				<div class="list_box">
					<h4>유튜브</h3>
		...
		<div class="sec_2_bot">
			<div class="sec_2_bot_wrap">
				...
				<a href="#n" title="새창" target="_blank"><span>더 자세히 알아보기</span></a>
			</div>
		</div>
	</div>
...
<div id="event_main_sec_3">
	<div class="wrap">
		...
		<a href="#n" title="새창" target="_blank"><span>다운로드</span></a>
	</div>
</div>
