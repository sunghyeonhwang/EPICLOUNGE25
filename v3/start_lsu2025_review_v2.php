...
<body>
		...
		<div class="video-section">
			<div class="video-container">
				...
				<iframe class="youtube-embed" 
						 src="https://www.youtube.com/embed/wZeCSjImn5M?autoplay=0&controls=1&rel=0&showinfo=0&modestbranding=1&enablejsapi=1"
		...
		<div class="info-section">
			<div class="info-header">
				...
				<div class="file-controls">
					<a href="https://unrealsummit16.cafe24.com/2025/start_twinunreal/lets_start_Twue2w.pdf" download target="_blank">
	...
	<div class="navigation-box">
		<button class="nav-button" id="prevBtn" onclick="location.href='https://epiclounge.co.kr/start_lsu2025_review_v1.php'" title="이전 주차">
			‹
		</button>
		<div class="week-label" id="weekLabel">2주차 | 트윈모션에서 전시공간 구성하기</div>
		<button class="nav-button" id="nextBtn" onclick="location.href='https://epiclounge.co.kr/start_lsu2025_review_v3.php'" title="다음 주차">
			›
		</button>
	</div>
	...
	<script>
		// 고정된 구글 시트 URL
		const FIXED_SHEETS_URL = 'https://docs.google.com/spreadsheets/d/190G5qF14kIlHNXwdSnmimHFv7Jb0GlXL6geFNfIKrf8/edit?usp=sharing';
