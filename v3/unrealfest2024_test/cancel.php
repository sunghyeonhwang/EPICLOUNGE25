...
if ($mode2 == 'del2') {
  ...
  $sql = "select * from cb_unreal_2024_event2_apply where apply_no = '$apply_no' limit 1";
  ...
  $result = $mysqli -> query($sql2);
    ...
    $sql3 = "delete from cb_unreal_2024_event2_apply_inquire where apply_user_email = '".$obj['apply_user_email']."'";
  ...
  echo "location.replace('https://epiclounge.co.kr/v3/unrealfest2024_test/index.html');";
  echo '</script>';
  exit();
