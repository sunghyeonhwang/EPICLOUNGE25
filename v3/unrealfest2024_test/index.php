...
<html lang="kr" dir="ltr">
  ...
  <head>
	...
	<!-- Meta Tags-->
	<meta name="description" content="UNREALFEST 2024 - Coming Soon">
  ...
  <link rel="icon" href="img/favicon/favicon-dark.svg" type="image/svg+xml" media="(prefers-color-scheme: dark)">
  <link rel="icon" href="img/favicon/favicon-light.svg" type="image/svg+xml" media="(prefers-color-scheme: light)">

  <link rel="mask-icon" href="img/favicon/mask-icon.svg" color="#424242">
  ...
  <!-- Template Favicon & Icons End -->
	...
	<meta property="og:url" content="https://epiclounge.co.kr/v3/unrealfest2024_test/">
   ...
   <ul class="top1menu clearfix">
	...
	<li class="depth1"> <a href="/contents/event_list.php?category=커뮤니티 이벤트" target="_self" class="tit depth1_ti"><span>이벤트</span></a><div>
			<div class="menu_bg clearfix"> 
					...
					<div class="lnb_menu_box">
					<!--	<strong><a href="https://epiclounge.co.kr/unrealfest.php" target="_blank" class="tit02">언리얼 페스트 서울</a></strong>-->
						<ul class="depth2">
							<li class="tit02_2_1"><a href="https://epiclounge.co.kr/v3/unrealfest2024_test/" target="_blank" class="tit02" style="color:#00C2E8">언리얼 페스트 2024 서울</a></li>
...
<div id="member_top" class="header_2">
	...
	<p class="confirm_btn"><a href="application_confirm.html" class="btn_2" target="_blank">등록 확인</a><a href="#event_cont_3" class="btn_1" target="_blank">등록 하기</a></p>
</div>
		...
		<div class="wrap">
			...
			<div class="program_wrap ">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="4" class="cate_all">
									...
									<span class="title ti_3">키노트. 2024년 그리고 그 이후의 언리얼 엔진</span>
									<span class="text">Epic Games, VP Engineering, Unreal Engine, Simon Tourangeau	</span>		
									</button>
								</td>
							</tr>
							<!--<tr class="active">
							...
							<tr>
								...
								<td class="cate_td3" rowspan="2">
									<!--<button type="button" data-btn-pop="pop_28_4" class="program_part part1" data-category="영화&TV, 애니메이션, 방송">-->
										<span class="title ti_2">영화&TV, 애니메이션, 방송을 위한 언리얼 엔진 로드맵</span>
										<span class="text">Epic Games Los Angeles, Kevin Cushing</span>
									<!--</button>-->
							...
							<tr>
								<td  class="cate_td2 deactive">
									<span class="title ti_1">TBC</span>
							...
							<tr>
								...
								<td class="cate_td1 deactive" >
									<span class="title ti_2">TBC</span>
									<!--
									<button type="button" data-btn-pop="pop_28_10" class="program_part part5" data-category="게임:프로그래밍">
									<span class="title ti_2">&lt;철권 8&gt;  출시와 동시에 12,000개 아이템 공개! 캐릭터 커스터마이징 아이템 제작과 차세대 콘솔 대응 방법</span>
							...
							<tr>
								...
								<td class="cate_td4">
									...
									<span class="title ti_2">분산 렌더링 시스템: 고화질 VR 렌더링을 압도적으로 빠르게!</span>
									<span class="text">어메이즈브이알 코리아, 김범진</span>
								</td>
							</tr>
							<tr class="active">
				...
				<div class="program_content">
						...
						<tbody>
							...
							<tr>
								...
								<td class="cate_td1">
									...
									<span class="title ti_2">바로 적용해보는 언리얼 엔진 디버깅, 프로파일링 툴 그리고 팁 & 트릭</span>
							...
							<tr>
								...
								<td class="cate_td1">
									...
									<span class="text">Epic Games Korea, Dmitriry Dyomin</span>
									</button>
								</td>
								<td class="cate_td2">
							...
							<tr>
								...
								<td class="cate_td2 deactive">
									...
									<span class="title ti_2">&lt;inZOI&gt;의 도시 제작과 캐릭터 커스터마이즈 </span>
							...
							<tr>
								<td class="time_td">15:30~16:20</td>
								<td  class="cate_td1">
							...
							<tr>
								...
								<td  class="cate_td4">
									...
									<span class="title ti_2">효율적인 리테일 매장 디자인 및 리소스 관리를 위한 솔루션 개발 사례</span>
									<span class="text">제일기획, 김진성/김종열<br />류프로덕션, 류충현</span>
									</button>
								</td>
					...
					<p class="text_center fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once"><a href="https://unrealsummit16.cafe24.com/2024/uf24/session_1_TBC.pdf" class="pdf_down" target="_blank">전체 세션 PDF 다운로드</a></p>
	...
	<div id="event_cont_3">
		<div class="wrap">
			...
			<div class="member_title_box index_type fromTopIn" data-scroll="">
				<p class="title"><em class="em_red">얼리버드 1차 50% 할인</em> 기회를 놓치지 마세요!</p>
				<ol>
					<li class="active">
						<span class="text_1">얼리버드 1차 50% 할인</span>
						<span class="text_2">7/16(화) ~ 7/25(목)까지</span>
					</li>
					<li>
						<span class="text_1">얼리버드 2차 30% 할인</span>
						<span class="text_2">7/26(금) ~ 8/6(화)까지</span>
					</li>
					<li>
						<span class="text_1">정상 가격</span>
						<span class="text_2">8/7(수) ~ 8/27(화)까지</span>
					</li>
				</ol>
			</div>
			...
			<div class="ticket_buy_box  fromTopIn" data-scroll="">
				<div class="ticket_offline ticket_box">
					...
					<div class="text_box">
						...
						<a href="application_step1.html" target="_blank">유료 구매하기</a>
						<ul class="bu type2">
							<li>일자별 오프라인 티켓</li>
				...
				<div class="ticket_online ticket_box">
					...
					<div class="text_box">
						...
						<a href="application_step1_online.html" target="_blank" >무료 등록하기</a>
						<ul class="bu type2">
							<li>온라인 중계 시청 <br />(단, 사정에 따라 일부 세션으로 제한될 수 있음)</li>
							<li>각종 온라인 이벤트</li>
						</ul>
					</div>
				</div>
			...
			<div class="tab_cont">
				<div class="event_tab_cont tab_cont_1  fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
					<div class="off_event_1 event_box">
						...
						<p class="img_box"><img src="https://unrealsummit16.cafe24.com/2024/uf24/1st_event.png" /></p>
						<!--<p class="ticket_text">
							<span>양일권</span>
							<span>28, 29일권</span>
						</p>-->
				...
				<div class="event_tab_cont tab_cont_2">
					<div class="event-layer">
						<img class="event-img-on" alt="추후 공개 예정" style="">이미지
					</div>
					<!--<div class="on_event_1 event_box  fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
						
						<!--<h3 class="h3"><i class="num_i">1</i>출석 체크 이벤트</h3>

						<p class="text">2일간  언리얼 페스트를 시청하시면 추첨을 통해 총 300분께 언리얼 굿즈를 드립니다.</p>
						<p class="img_box"><img src="https://unrealsummit16.cafe24.com/2024/uf24/prize.png" /></p>
	...
	<div id="event_cont_5">
		<div class="wrap">
			...
			<ul class="logo_list  fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<li><a href="https://www.perforce.com/ko" target="_blank" title="새창"><img src="https://unrealsummit16.cafe24.com/2024/uf24/logo_list_perforce.svg"></a></li>
				<!--<li><a href="#" target="_blank" title="새창"><img src="https://unrealsummit16.cafe24.com/2024/uf24/logo_list_2.png"></a></li>
				<li><a href="#" target="_blank" title="새창"><img src="https://unrealsummit16.cafe24.com/2024/uf24/logo_list_3.png"></a></li>-->
			</ul>
		...
		<div class="wrap">
			...
			<div class="acc_list">
				  <div class="acc_item  fromTopIn " data-scroll="toggle(.fromTopIn, .fromTopOut) once">
					  ...
					  <div class="acc_con">
						  <p>언리얼 페스트 2024 서울은 8월 28일~29일까지 양일간 오프라인과 온라인으로 함께 진행됩니다.<br /><em class="em_blue"><a href="https://epiclounge.co.kr/v3/unrealfest2024_test/application_step1.html" target="_blank" style="color: #00C2E8; font-weight: bold;">오프라인 등록</a></em>은 유료로 오프라인에서 원하는 일자별로 현장감 있는 세션을 듣고, 한정판 굿즈 수령, Q&A 기회, 부스 체험 및 각종 이벤트 등에 참여하고 싶은 경우 이용해 주세요. 단, 한정 수량으로 조기 마감될 수 있으니 빠른 등록을 권장합니다. <em class="em_blue"><a href="https://epiclounge.co.kr/v3/unrealfest2024_test/application_step1_online.html" target="_blank" style="color: #00C2E8; font-weight: bold;">온라인 등록</a></em>은 무료로 장소에 관계 없이 세션을 온라인으로 시청하시고 싶거나, 오프라인 유료 등록이 마감된 경우에 이용해 주세요. 단, 발표자의 동의 여부와 송출 컨디션에 따라 전체 세션의 온라인 중계는 어려울 수도 있다는 점 양해 부탁드립니다.</p>
						  <button type="button" class="acc_btn ">
					...
					<div class="acc_item fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
						...
						<div class="acc_con">
							<p>네. <a href="https://epiclounge.co.kr/v3/unrealfest2024_test/application_step1.html" target="_blank" style="color: #00C2E8; font-weight: bold;"><em class="em_blue">오프라인 유료 등록</em></a>과 <a href="https://epiclounge.co.kr/v3/unrealfest2024_test/application_step1_online.html" target="_blank" style="color: #00C2E8; font-weight: bold;"><em class="em_blue">온라인 무료 등록</em></a> 모두 행사 시작 전까지 등록을 완료하셔야 참석 및 시청하실 수 있습니다.</p>
							<button type="button" class="acc_btn ">
							  <span style="color:#FF8080">닫기</span>
							  </button>
						</div>
					...
					<div class="acc_item fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
						...
						<div class="acc_con">
							<p>메뉴바 우측에 있는 <a href="https://epiclounge.co.kr/v3/unrealfest2024_test/application_confirm.html" target="_blank" style="color: #00C2E8; font-weight: bold;">등록 확인</a> 페이지에서 등록 정보를 직접 수정하실 수 있습니다.</p>
							<button type="button" class="acc_btn ">
							  <span style="color:#FF8080">닫기</span>
							  </button>
						</div>
			...
			<div class="acc_list">
				  ...
				  <div class="acc_item fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
					  ...
					  <div class="acc_con">
						  <p>메뉴바 우측에 있는 <a href="https://epiclounge.co.kr/v3/unrealfest2024_test/application_confirm.html" target="_blank" style="color: #00C2E8; font-weight: bold;">등록 확인</a>을 클릭하여 직접 결제 취소를 진행하시면 됩니다. 단, 환불은 행사 1일 전인 2024년 8월 27일(화) 09시 00분까지 취소하신 경우에만 가능하며, 결제 취소 후 최대 5일 이내 전액 환불됩니다.</p>
						  <button type="button" class="acc_btn ">
							<span style="color:#FF8080">닫기</span>
							</button>
					  </div>
		...
		<div class="footer_top">
			...
			<div class="footer_link">
				...
				<div class="footer_link_list">
					<h3>이벤트</h3>
					<ul>
						<li><a href="https://epiclounge.co.kr/v3/unrealfest2024_test/" target="_blank" style="color:#00C2E8">언리얼 페스트 2024서울</a></li>
