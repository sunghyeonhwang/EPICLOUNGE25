...
<?php
    ...
    //' 라이센스 파일
    //'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    $license = "hp_V62330000000_IDS_01_PROD_AES_license.dat";
...
?>
        if(opener.document.kcbResultForm.apply_track.value == "쿠폰") {
            ...
            if (opener.document.kcbResultForm.apply_product_code.value == "NORMAL_ALL" ||
                opener.document.kcbResultForm.apply_product_code.value == "NORMAL_28" ||
                opener.document.kcbResultForm.apply_product_code.value == "NORMAL_29") {

                opener.document.kcbResultForm.action = "/v3/unrealfest2024_test/application_step2_coupon1.html";
                ...
                opener.document.kcbResultForm.action = "/v3/unrealfest2024_test/application_step2_coupon2.html";
                opener.document.kcbResultForm.submit();
                self.close();
            } else {
                opener.document.kcbResultForm.action = "/v3/unrealfest2024_test/application_step2_online.html";
                opener.document.kcbResultForm.submit();
                self.close();
            }
            ...
            if (opener.document.kcbResultForm.apply_product_code.value == "NORMAL_ALL" ||
                ...
                opener.document.kcbResultForm.action = "/v3/unrealfest2024_test/application_step2_worker.html";
                opener.document.kcbResultForm.submit();
                self.close();
            } else if (opener.document.kcbResultForm.apply_product_code.value == "STD_ALL" ||
                opener.document.kcbResultForm.apply_product_code.value == "STD_28" ||
                ...
                opener.document.kcbResultForm.action = "/v3/unrealfest2024_test/application_step2_student.html";
                opener.document.kcbResultForm.submit();
                self.close();
            } else {
                opener.document.kcbResultForm.action = "/v3/unrealfest2024_test/application_step2_online.html";
