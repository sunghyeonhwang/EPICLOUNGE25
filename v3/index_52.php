...
<div class="visual_slide_list main_slide_13" data-v="2">
		...
		<div class="visual_mp4">
			 <video autoplay loop muted class="video w_video">
				<source src="https://unrealsummit16.cafe24.com/2023/site/52_r/52r.mp4" type="video/mp4">
			</video>
		</div>
		<div class="visual_text_box">
			<div class="text_box1">
				...
				<p class="info_text">
					<span class="eng_text"><img src="https://unrealsummit16.cafe24.com/2023/site/52_r/ue52webinar.png" /></span>
				</p>
			</div>
			<div class="text_box2">
	
				<span class="text"></span>
				<a href="https://epiclounge.co.kr/unrealengine_52.php"  target="_blank" class="btn_6">자세히 보기</a>
			</div>
		</div>
	</div>
	<div class="visual_slide_list main_slide_13" data-v="2">
