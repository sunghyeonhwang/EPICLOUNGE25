...
if ($mode == 'write') {
  ...
  $mysqli = new mysqli("localhost","unrealengine","Good121930!@","unrealengine");
    ...
    $sql = "select count(*) from cb_unreal_2025_event_apply where apply_ci = '$_apply_ci' limit 1";
  ...
  $sql = "INSERT INTO cb_unreal_2025_event_apply (
      apply_user_name, 
      apply_user_email,
      apply_user_phone,
      apply_user_job, 
...
//문자 발송 종료
    ...
    if($wait_yn == 'Y'){
        ...
        $mysqli = new mysqli("localhost","unrealengine","Good121930!@","unrealengine");
        $sql = "INSERT INTO cb_unreal_2025_event_apply_inquire(
    apply_user_name, 
    apply_user_email,
    apply_user_phone,
    apply_user_company, 
  ...
  $sql = "select count(*) from cb_unreal_2025_event_apply where apply_user_email = '$apply_user_email' and apply_no != '$apply_no' limit 1";
  $result = $mysqli -> query($sql);
  $obj = $result -> fetch_array();
  if($obj[0]['count']){
    echo '<script type="text/javascript">';
  ...
  $sql = "UPDATE cb_unreal_2025_event_apply SET
  ...
  $result = $mysqli -> query($sql);
    ...
    if($wait_yn == 'Y'){
        $old_obj = sql_fetch("select * from cb_unreal_2025_event_apply WHERE apply_no = '$apply_no' ");
        $wait_cnt = sql_fetch("select count(*) cnt from cb_unreal_2025_event_apply_inquire where  apply_user_phone = '".$old_obj["apply_user_phone"]."' ");
        if($wait_cnt["cnt"] == 0){
    ...
    '$apply_user_grade'
        ...
        $old_obj = sql_fetch("select * from cb_unreal_2025_event_apply WHERE apply_no = '$apply_no' ");
        sql_query("delete from cb_unreal_2025_event_apply_inquire where  apply_user_phone = '".$old_obj["apply_user_phone"]."' ");
    }
  $mysqli -> close();
    ?>
  ...
  $sql = "select apply_user_email,apply_user_phone,apply_password from cb_unreal_2025_event_apply where apply_no = '$apply_no' limit 1";
  ...
  $sql2 = "UPDATE cb_unreal_2025_event_apply SET
  ...
  $mysqli = new mysqli("localhost","unrealengine","Good121930!@","unrealengine");
  $sql = "INSERT INTO cb_unreal_2025_event_apply_inquire_qna(
    apply_user_name, 
    apply_user_email,
    apply_user_phone,
    apply_user_company, 
