...
<div class="container"> 
	...
	<div class="board_view resource_view replay_view"> <!-- 뉴스면 뉴스 리소스면 리소스 이벤트면 이벤트라고 클래스 --> 
		...
		<div class="board_top_text">
			...
			<span class="board_top_name"><?=$RData["speker"]?></span>
		<div class="board_file_box_rep">
			<a href="<?=$RData["pdf_url"] ? $RData["pdf_url"]:"javascript:alert('첨부파일이 없습니다.')"?>" target="_blank" title="파일다운로드"><span class="file_icon"><em>다운로드 PDF</em></span></a>
		</div>
