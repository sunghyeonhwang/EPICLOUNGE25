...
<body>
		...
		<div class="video-section">
			<div class="video-container">
				...
				<iframe class="youtube-embed" 
						 src="https://www.youtube.com/embed/3CPNc5wDfHo?autoplay=0&controls=1&rel=0&showinfo=0&modestbranding=1&enablejsapi=1"
		...
		<div class="info-section">
			<div class="info-header">
				...
				<div class="file-controls">
					<a href="https://unrealsummit16.cafe24.com/2025/start_twinunreal/lets_start_Twue6w.pdf" download target="_blank">
	...
	<div class="navigation-box">
		<button class="nav-button" id="prevBtn" onclick="location.href='https://epiclounge.co.kr/start_lsu2025_review_v5.php'" title="이전 주차">
			‹
		</button>
		<div class="week-label" id="weekLabel">6주차 | 언리얼 엔진에서 인터랙티브 컨피규레이터 구성하기</div>
		<button class="nav-button" id="nextBtn" disabled title="다음 주차">
			›
		</button>
	</div>
	...
	<script>
		// 고정된 구글 시트 URL
		const FIXED_SHEETS_URL = 'https://docs.google.com/spreadsheets/d/1OKHR7O2qbTjqklwrosloRet-O3vWDJDkCKWwN20ZOeE/edit?usp=sharing';
