...
<section class="visual_slide visual_slide_1">
	...
	<div class="visual_slide_list main_slide_1"  data-v="1">
		...
		<div class="visual_text_box">
			<div class="text_box1">
				<p class="num_text">
					<img src="/v3/resource/images/main/main_num_text1.png" />
				</p>
				<p class="info_text">
					<span class="eng_text"><img src="/v3/resource/images/main/ue_logo.png" /></span>
					<span class="kor_text">출시 웨비나</span>
				</p>
			</div>
			<div class="text_box2">
				<span class="text"><em>일시<span>|</span>04.14 2PM</em><em>채널<span>|</span>에픽 라운지</em></span>
				<a href="https://epiclounge.co.kr/index_unrealengine.php">자세히 보기</a>
			</div>
		</div>
	</div>
    ...
    <section class="news_sec">
        <div class="wrap">
            ...
            <div class="con">
				...
				<div class="list_box">
					<a href="https://epiclounge.co.kr/v3/contents/news_list.php?category=%EB%89%B4%EC%8A%A4">
						<div class="news_img">
							<img src="/v3/resource/images/main/news_banner_1.png" />
						</div>
						<div class="news_text">
							<span class="news_text_date">뉴스</span>
							<!--<span class="news_text_title">언리얼 엔진 뉴스</span>-->
							<span class="news_text_info">에픽 라이브<br />뉴스&하이라이트에서<br />최신소식을 확인해 보세요!</span>
							
						</div>
					</a>
				</div>
				<div class="list_box">
					<a href="https://epiclounge.co.kr/v3/contents/news_list.php?category=%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8/%EC%B6%9C%EC%8B%9C">
						<div class="news_img">
							<img src="/v3/resource/images/main/news_banner_2.png" />
						</div>
						<div class="news_text">
							<span class="news_text_date">출시 &#38; 업데이트</span>
							<span class="news_text_info">5월에 무료로 제공되는<br />마켓플레이스 콘텐츠를<br />만나보세요!</span>
							<!--<span class="news_text_date">2022.04.01-30</span>-->
						</div>
					</a>
				</div>
				<div class="list_box">
					<a href="https://epiclounge.co.kr/v3/contents/news_list.php?category=%EB%B8%94%EB%A1%9C%EA%B7%B8">
						<div class="news_img">
							<img src="https://unrealsummit16.cafe24.com/site/news_banner_3.png" />
						</div>
						<div class="news_text">
							<span class="news_text_date">블로그</span>
							<span class="news_text_info">언리얼 엔진 X 넷플릭스 시리즈<br />'고요의 바다'의 제작 비결을<br />알아보세요.</span>
							<!--<span class="news_text_date">2022.04.01-30</span>-->
						</div>
					</a>
				</div>
