	...
	<div class="visual_slide_list main_slide_14" data-v="3">
		...
		<div class="visual_text_box">
			<div class="text_box1">
				...
				<p class="info_text">
					<span class="eng_text"><img src="https://unrealsummit16.cafe24.com/2023/fest_src/text_logo.svg" /></span>
			...
			<div class="text_box2">
				...
				<a href="https://epiclounge.co.kr/unrealfest.php"  target="_blank" class="btn4">종료</a>
			</div>
		</div>
	</div>
<div class="visual_slide_list main_slide_14" data-v="3">
	...
	<div class="visual_text_box">
		<div class="text_box1">
			...
			<p class="info_text">
				<span class="eng_text"><img src="/v3/img/challenge_result.png" /></span>
				<!--<span class="kor_text">다시보기</span>-->
			</p>
		</div>
		<div class="text_box2">
			...
			<span class="text"></span>
			<a href="https://epiclounge.co.kr/v3/contents/event_view.php?rsc_bbs_idx=251"  target="_blank" class="btn3">자세히 보기</a>
		</div>
	</div>
</div>
	<div class="visual_slide_list main_slide_13" data-v="2">
		...
		<div class="visual_text_box">
			...
			<div class="text_box2">
				...
				<span class="text"></span>
				<a href="https://www.unrealengine.com/ko/blog/unreal-engine-5-2-is-now-available"  target="_blank" class="btn_6">자세히 보기</a>
			</div>
		</div>
	</div>
