    ...
    <script>(function(d, s, id) {
        ...
        <script>
              function clip(){
                  ...
                  var url = 'https://epiclounge.co.kr/v3/unrealsummit2022.php';    // <a>태그에서 호출한 함수인 clip 생성
                ...
                // NAVER
                  function shareNaver() {
                    const title = "언리얼 서밋 온라인 2022";
                    const url = "https://epiclounge.co.kr/v3/unrealsummit2022.php";
                    window.open(
            ...
            <div class="visual_con">
                <div class="visual_con_inner">
                    ...
                    <div class="con_inner">
                        ...
                        <!--                    </h2>-->
                       <!--   <div class="btn_wrap">
                           <button type="button" class="visual_btn type1"><a href="https://epiclounge.co.kr/v2/application_check_in.html" target="_blank">시청하기</a></button>
                ...
                <div class="program_content">
                    ...
                    <article class="program program1">
                        <button type="button" data-btn-pop="" class="program_part part1" data-category="">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg.jpg)"></span>
                                <span class="title">
                                    <span class="num">1</span>
                                    <span class="time">13:00-13:10</span>
                                </span>
                            </span>
                        ...
                        <button type="button" data-btn-pop="pop_2"  class="program_part part2"  data-category="공통,메타버스,크로스 플랫폼,초급">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg222.jpeg)"></span>
                                <span class="title">
                    ...
                    <article class="program program2">
                        <button type="button"  data-btn-pop="pop_3"  class="program_part part1" data-category="공통,비주얼아트,UE5,디지털 휴먼,PC,초급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg2.jpeg)"></span>
                                <span class="title">
                        ...
                        <button type="button" data-btn-pop="pop_4"  class="program_part part2" data-category="공통,게임,프로그래밍,비주얼아트,크로스 플랫폼,초급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/chaos-scene-queries-unreal-engine-5-feed-1920x1080-a6238501039b.jpeg)"></span>
                                <span class="title">
                    ...
                    <article class="program program3">
                        <button type="button" data-btn-pop="pop_5"  class="program_part part1" data-category="공통,비주얼아트,UE5,PC,초급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg4.jpeg)"></span>
                                <span class="title">
                        ...
                        <button type="button"  data-btn-pop="pop_6" class="program_part part2" data-category="공통,프로그래밍,크로스 플랫폼,초급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg5.jpeg)"></span>
                                <span class="title">
                ...
                <div class="program_content">
                    <article class="program program1">
                        <button type="button"  data-btn-pop="pop_7" class="program_part part1" data-category="게임,비주얼아트,UE5,버추얼 프로덕션,디지털 휴먼,디지털 트윈,메타버스,크로스 플랫폼,PC,콘솔,중급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg77.jpeg)"></span>
                                <span class="title">
                                    <span class="num">1</span>
                        ...
                        <button type="button" data-btn-pop="pop_8" class="program_part part2" data-category="게임,프로그래밍,크로스 플랫폼,PC,모바일,콘솔,중급">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg6.jpg)"></span>
                                <span class="title">
                                    <span class="num">2</span>
                    ...
                    <article class="program program2">
                        <button type="button"   data-btn-pop="pop_9" class="program_part part1" data-category="게임,비주얼아트,크로스 플랫폼,PC,콘솔,중급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg9r.jpeg)"></span>
                                <span class="title">
                                    <span class="num">3</span>
                        ...
                        <button type="button"  data-btn-pop="pop_10" class="program_part part2" data-category="게임,프로그래밍,UE5,크로스 플랫폼,PC,콘솔,중급">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg9.jpeg)"></span>
                                <span class="title">
                                    <span class="num">4</span>
                    ...
                    <article class="program program6">
                        <button type="button"   data-btn-pop="pop_11" class="program_part part1" data-category="프로그래밍,UE5,모바일,중급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg11u.jpeg)"></span>
                                <span class="title">
                                    <span class="num">5</span>
                ...
                <div class="program_content">
                    <article class="program program1">
                        <button type="button" data-btn-pop="pop_12" class="program_part part1" data-category="영화 & TV,애니메이션,비즈니스/마케팅,XR/VR/AR/MR,UE5,버추얼 프로덕션,디지털 휴먼,메타버스,크로스 플랫폼,중급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://cdn2.unrealengine.com/body-9-spotlight-unrealforallcreators-1920x1080-019453366.jpg)"></span>
                                <span class="title">
                                    <span class="num">1</span>
                        ...
                        <button type="button" data-btn-pop="pop_13" class="program_part part2" data-category="영화 & TV,애니메이션,비주얼아트,기획/프로덕션,UE5,중급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg32.jpeg)"></span>
                                <span class="title">
                                    <span class="num">2</span>
                    ...
                    <article class="program program2">
                        <button type="button" data-btn-pop="pop_14" class="program_part part1" data-category="애니메이션,비주얼아트,기획/프로덕션,기타,중급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg14.jpeg)"></span>
                                <span class="title">
                                    <span class="num">3</span>
                    ...
                    <article class="program program3">
                        <button type="button" data-btn-pop="pop_16" class="program_part part1" data-category="영화 & TV,프로그래밍,비주얼아트,XR/VR/AR/MR,디지털 휴먼,메타버스,PC,초급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg16.jpeg)"></span>
                                <span class="title">
                                    <span class="num">5</span>
                        ...
                        <button type="button" data-btn-pop="pop_17" class="program_part part2" data-category="영화 & TV,XR/VR/AR/MR,UE5,버추얼 프로덕션,기타,초급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg17.jpg)"></span>
                                <span class="title">
                                    <span class="num">6</span>
                ...
                <div class="program_content">
                    <article class="program program1">
                        <button type="button" data-btn-pop="pop_18" class="program_part part1" data-category="건축, 제조 & 시뮬레이션,기획/프로덕션,서비스,XR/VR/AR/MR,UE5,디지털 트윈,메타버스,기타,초급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg18.jpeg)"></span>
                                <span class="title">
                                    <span class="num">1</span>
                        ...
                        <button type="button" data-btn-pop="pop_19" class="program_part part2" data-category="건축, 제조 & 시뮬레이션,XR/VR/AR/MR,디지털 트윈,PC,중급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg19.jpg)"></span>
                                <span class="title">
                                    <span class="num">2</span>
                            ...
                            <span class="program_con">
                                <h3>&#60;VARLOS&#62; 항만 모니터링 시스템: 효율적인 항만 물류 관리를 위한 디지털 트윈 구축</h3>
                    ...
                    <article class="program program2">
                        <button type="button" data-btn-pop="pop_20" class="program_part part1" data-category="건축, 제조 & 시뮬레이션,서비스,XR/VR/AR/MR,디지털 트윈,PC,모바일,MS Hololens,초급,기타">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg204.jpeg)"></span>
                                <span class="title">
                                    <span class="num">3</span>
                        ...
                        <button type="button" data-btn-pop="pop_21" class="program_part part2" data-category="공통,비주얼아트,UE5,디지털 트윈,PC,중급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg21.jpeg)"></span>
                                <span class="title">
                                    <span class="num">4</span>
                    ...
                    <article class="program program3">
                        <button type="button" data-btn-pop="pop_22" class="program_part part1" data-category="건축, 제조 & 시뮬레이션,서비스,UE5,디지털 트윈,메타버스,PC,초급,">
                            <span class="img_wrap">
                                <span class="img" style="background-image:url(https://unrealsummit16.cafe24.com/v3/resource_0830/session_bg2222.jpg)"></span>
                                <span class="title">
                                    <span class="num">5</span>
                            ...
                            <span class="program_con">
                                <h3>서울시 3차원 공간자료(S-Map)활용 디지털 가상서울 구현사례</h3>
                              ...
                              <div class="event_item_con">
                                  <ul class="event_giveaway_list">
                                      <li class="event_giveaway_item">
                                          ...
                                          <div class="giveaway">
                                              <div class="img">
                                                  <img src="https://unrealsummit16.cafe24.com/v3/resource_0829/images/main/event2_prize_1.png" alt="">
                                              </div>
...
<li class="event_giveaway_item">
                                          ...
                                          <div class="giveaway">
                                              <div class="img">
                                                  <img src="https://unrealsummit16.cafe24.com/v3/resource_0829/images/main/prize55.png" alt="">
                                              </div>
