...
$sql_common = " from cb_unreal_2023_event_apply_inquire_qna a ";
$sql_search = " where 1 ";
...
$sql_all_cnt = " select count(*) as cnt from cb_unreal_2023_event_apply where apply_pay_status = 10  ";
$row_all_cnt = sql_fetch($sql_all_cnt);


$sql_free_cnt = " select count(*) as cnt from cb_unreal_2023_event_apply  where apply_pay_status = 10 and free_yn='Y' ";
$row_free_cnt = sql_fetch($sql_free_cnt);

$sql_pay_cnt = " select count(*) as cnt from cb_unreal_2023_event_apply  where apply_pay_status = 10 and free_yn='N' ";
$row_pay_cnt = sql_fetch($sql_pay_cnt);

$sql_refund_cnt = " select count(*) as cnt from cb_unreal_2023_event_apply  where IFNULL(refund_date,'') <> '' ";
$row_refund_cnt = sql_fetch($sql_refund_cnt);


$sql_wait_cnt = " select count(*) as cnt from cb_unreal_2023_event_apply_inquire_qna ";
