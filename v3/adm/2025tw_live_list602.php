...
$sql_common = " from cb_unreal_2025_event_apply_live a ";
$sql_search = " where 1 ";
...
<select class="" name="apply_reg_datetime">
    ...
    <option value="2025-04-23" <?php if($apply_reg_datetime == '2025-04-23'){?>selected<?php } ?>>1W</option>
    <option value="2025-04-30" <?php if($apply_reg_datetime == '2025-04-30'){?>selected<?php } ?>>2W</option>
    <option value="2025-05-07" <?php if($apply_reg_datetime == '2025-05-07'){?>selected<?php } ?>>3W</option>
    <option value="2025-05-14" <?php if($apply_reg_datetime == '2025-05-14'){?>selected<?php } ?>>4W</option>
    <option value="2025-05-21" <?php if($apply_reg_datetime == '2025-05-21'){?>selected<?php } ?>>5W</option>
    <option value="2025-05-28" <?php if($apply_reg_datetime == '2025-05-28'){?>selected<?php } ?>>6W</option>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#export_to_excel15', function() {
        var f = document.fsearch2;
        f.export.value = "rand60"; // 이 라인 추가 또는 수정
        f.submit();
        f.export.value = "";
    });
