	...
	<div id="event_cont_2">
		<div class="wrap">
			...
			<div class="date_header fromTopIn" data-scroll="">
				...
				<a href="https://unrealsummit16.cafe24.com/2025/ufest25/Unrealfest2025_Agenda_pdf.pdf" target="_blank">
			...
			<div class="ticket_buy_box fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<div class="ticket_offline ticket_box">
					<div class="text_box">
						...
						<a href="javascript:alert('종료 되었습니다.')" onfocus="this.blur()">등록 마감</a>
					</div>
				</div>
