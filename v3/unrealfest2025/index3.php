...
include_once "member_header2.php";
?>
...
<div id="sns_fixed">
    <a href="#"
       onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index2.php'), 'facebook-share-dialog', 'width=626,height=436'); return false;"><img
                src="/v3/unrealfest2025/images/link_icon1.svg"/></a><!-- 페이스북 -->
    <a href="#"
       onclick="window.open('https://twitter.com/intent/tweet?text=' + encodeURIComponent('언리얼 페스트 서울 2025 - 세션 정보') + '&url=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index2.php'), 'twitter-share-dialog', 'width=550,height=420'); return false;"><img
                src="/v3/unrealfest2025/images/link_icon2.svg"/></a><!-- 트위터 -->
				<!--
    <a href="#"
       onclick="window.open('https://www.instagram.com/sharer.php?u=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index2.php'), 'instagram-share-dialog', 'width=626,height=436'); return false;"><img
                src="/v3/unrealfest2025/images/link_icon3.svg"/></a> -->
    <a href="#"
       onclick="navigator.clipboard.writeText('https://epiclounge.co.kr/v3/unrealfest2025/index2.php').then(() => alert('링크가 복사되었습니다.')); return false;"><img
                src="/v3/unrealfest2025/images/link_icon4.svg"/></a><!-- 링크 -->
</div>
<div class="event_wrap">
	<div id="event_visual">
		<div class="visual_mp4">
			 <video autoplay="" loop="" muted="" class="video w_video" playsinline="">
				<source src="https://unrealsummit16.cafe24.com/2025/ufest25/UEF25_Back(B65).mp4" type="video/mp4">
			</video>
		</div>
	...
	<div id="event_cont_4">
		<div class="wrap">
			...
			<div class="sponsor_box2 fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<p class="sp_img">
					<img src="/v3/unrealfest2025/images/sponsor_img3.png">
				</p>
				<p class="sp_img">
					<img src="/v3/unrealfest2025/images/sponsor_img4.png">
				</p>
				<p class="sp_img">
					<img src="/v3/unrealfest2025/images/sponsor_img5.png">
				</p>
				<p class="sp_img">
					<img src="/v3/unrealfest2025/images/sponsor_img6.png">
				</p>
			</div>
		</div>
	</div>
	...
	<div id="event_cont_6">
		<div class="wrap">
			<div class="section_title fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once"><h3>FAQ</h3></div>
			<div class="faq">
			...
			<div class="acc_list">
				  ...
				  <div class="acc_item fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
					  ...
					  <div class="acc_con">
						  <p>행사 종료 후 홈페이지 메뉴바 우측의 ‘등록 확인’에서 본인 확인을 하시면 참가 확인증을 확인하고 다운로드하실 수 있습니다.</p>
						  <button type="button" class="acc_btn ">
							<span class="faq_close">닫기</span>
							</button>
					  </div>
				  ...
				  <div class="acc_item fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
					  ...
					  <div class="acc_con">
						  <p>이니시스 고객센터로 문의해 주세요. 결제 오류 외의 문의는 언리얼 페스트 사무국(02-326-3701) 또는 이메일로 연락해 주시기 바랍니다. 운영시간은 오전 10시~오후5시(점심시간 12시~1시 제외)입니다.</p>
						  <button type="button" class="acc_btn ">
							<span class="faq_close">닫기</span>
							</button>
					  </div>
				  ...
				  <div class="acc_item fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
					  ...
					  <div class="acc_con">
						  <p>메뉴바 우측의 ‘등록 확인’ 페이지에서 직접 결제 취소하실 수 있습니다. 환불은 8월 24일(일) 오전 9시까지 취소한 경우에만 가능하며, 최대 5일 이내 전액 환불됩니다. 단, 얼리버드 티켓은 해당 기간 이후에는 취소가 불가능합니다.</p>
						  <button type="button" class="acc_btn ">
							<span class="faq_close">닫기</span>
							</button>
					  </div>
				  ...
				  <div class="acc_item fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
					  ...
					  <div class="acc_con">
						  <p>언리얼 페스트 사무국(02-326-3701) 또는 이메일로 문의해 주세요. 운영 시간은 오전 10시부터 오후 5시까지이며, 점심시간(12시~1시)에는 응대가 어렵습니다.</p>
						  <button type="button" class="acc_btn ">
							<span class="faq_close">닫기</span>
							</button>
					  </div>
