						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3" class=" text_col_3 text_left big_td">
									<button type="button" data-btn-pop="pop_1_1"  data-btn-type="1"  class="program_part">
										...
										<span class="title">Epic's Vision</span>
										<span class="text_info"><span style="font-weight: 800;">Tim Sweeney</span>, Epic Games / Founder & CEO</span>
									</button>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3" class=" text_col_3 text_left big_td">
									...
									<span class="text_info"><span style="font-weight: 800;">Bill Clifford</span>, Epic Games /  Vice President and General Manager of Unreal Engine</span>
									</button>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="time_td"><span>16:40</span></td>
								<td class="sm_td">
                                    <? xls_loader_cel(12,1);?>
								</td>
			...
			<div class="ticket_buy_box fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<div class="ticket_offline ticket_box">
					<div class="text_box">
						...
						<a href="application_step1.php" style="color: #00FFDF" target="_blank">등록하기</a>
					</div>
				</div>
				...
				<div class="ticket_online ticket_box">
					<div class="text_box">
						...
						<a href="application_step1_online.php" target="_blank">등록하기</a>
					</div>
				</div>
			</div>		
	...
	<div id="event_cont_4">
		<div class="wrap">
			...
			<div class="sponsor_box1 fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<p class="sp_img sp_1"><a href="#" title="새창" target="_blank"><span></span></a></p>
				<p class="sp_img sp_2"><a href="#" title="새창" target="_blank"><span></span></a></p>
			</div>
			<div class="sponsor_box2 fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<p class="sp_img">
					<a href="#" title="새창" target="_blank"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/sponsor_img3.png"></a>
				</p>
				<p class="sp_img">
					<a href="#" title="새창" target="_blank"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/sponsor_img4.png"></a>
				</p>
				<p class="sp_img">
					<a href="#" title="새창" target="_blank"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/sponsor_img5.png"></a>
				</p>
				<p class="sp_img">
					<a href="#" title="새창" target="_blank"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/sponsor_img6.png"></a>
				</p>
			</div>
		</div>
	</div>
