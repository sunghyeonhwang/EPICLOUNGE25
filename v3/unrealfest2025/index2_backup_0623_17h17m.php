...
<div id="member_top" class="header_2">
	...
	<p class="confirm_btn"><a href="#event_cont_3" class="btn_1" >등록 하기</a><a href="/unrealfest2025/application_confirm.php" class="btn_2" target="_blank">등록 확인</a></p>
	</div>
</div>

<div id="sns_fixed">
    <a href="#"
       onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index2.php'), 'facebook-share-dialog', 'width=626,height=436'); return false;"><img
                src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon1.svg"/></a><!-- 페이스북 -->
    <a href="#"
       onclick="window.open('https://twitter.com/intent/tweet?text=' + encodeURIComponent('언리얼 페스트 서울 2025 - 세션 정보') + '&url=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index2.php'), 'twitter-share-dialog', 'width=550,height=420'); return false;"><img
...
<div class="event_wrap">
	<div id="event_visual">
		<div class="visual_mp4">
			 <video autoplay="" loop="" muted="" class="video w_video" playsinline="">
				<source src="https://unrealsummit16.cafe24.com/2025/ufest25/3_fusion_2.mp4" type="video/mp4">
			</video>
		</div>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3" class=" text_col_3 text_left big_td">
									<button type="button" data-btn-pop="pop_1_1"  data-btn-type="1"  class="program_part">
										...
										<span class="text_info"><span style="font-weight: 800;">Tim Sweeny</span>, Epic Games / Founder & CEO</span>
									</button>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3" class=" text_col_3 text_left big_td">
									...
									<span class="text_info"><span style="font-weight: 800;">Marcus Wassmer</span>, Epic Games / President of Product Development</span>
									</button>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="time_td" rowspan="2"><span>13:20</span></td>
								<td class="sm_td">
                                    <? xls_loader_cel(2,1);?>
								</td>
								
							
								<td class="sm_td" rowspan="2">
                                    <? xls_loader_cel(4,2);?>
								</td>
							...
							<tr>
								<td class="time_td"><span>14:20</span></td>
								<td class="sm_td">
                                    <? xls_loader_cel(6,1);?>
								</td>
							...
							<tr>
								<td class="time_td"><span>15:40</span></td>
								<td class="sm_td">
                                    <? xls_loader_cel(9,1);?>
								</td>
							...
							<tr>
								<td class="time_td"><span>17:40</span></td>
								<td class="sm_td">
                                    <? xls_loader_cel(15,1);?>
								</td>
				...
				<div class="program_content">
					...
					<colgroup>
						...
						<tbody>
							...
							<tr>
								<td class="time_td"><span>15:20</span></td>
								<td class="sm_td">
                                    <? xls_loader_cel(31,1);?>
								</td>
			...
			<div class="ticket_buy_box fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<div class="ticket_offline ticket_box">
					<div class="text_box">
						...
						<p class="text_1"><strong>50</strong><span>%</span></p>
	...
	<div id="event_cont_4">
		<div class="wrap">
			...
			<div class="sponsor_box1 fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<p class="sp_img sp_1"><span></span></p>
				<p class="sp_img sp_2"><span></span></p>
			</div>
			<div class="sponsor_box2 fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<p class="sp_img">
					<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/sponsor_img3.png">
				</p>
				<p class="sp_img">
					<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/sponsor_img4.png">
				</p>
				<p class="sp_img">
					<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/sponsor_img5.png">
				</p>
				<p class="sp_img">
					<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/sponsor_img6.png">
				</p>
			</div>
		</div>
	</div>
	...
	<div id="event_cont_5">
		<div class="wrap">
			<div class="section_title fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once"><h3>Event</h3></div>
			<div class="event_box_list no_pd">
				<div class="qr_event_box1 qr_event_box fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
					...
					<div class="text_box">
						...
						<p class="text_date"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/event_cal_blue.png"><span>8.25(월) ~ 8.26(화)</span></p>
						<p class="list_box">
							<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/off_event_img1.png">
							<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/off_event_img2.png">
						</p>
					</div>
				</div>
				...
				<div class="qr_event_box2 fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
					<div class="qr_event_box2_1 qr_event_box">
						...
						<div class="text_box">
							...
							<p class="text_date"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/event_cal_purple.png"><span>8.25(월)</span></p>
							<p class="list_box">
					...
					<div class="qr_event_box2_2 qr_event_box">
						...
						<div class="text_box">
							...
							<p class="text_date"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/event_cal_purple2.png"><span>8.25(월) ~ 8.26(화)</span></p>
							<p class="list_box">
		...
		<div class="wrap">
				...
				<div class="acc_item  fromTopIn " data-scroll="">
				  ...
				  <div class="acc_item  fromTopIn " data-scroll="">
					...
					<div class="acc_item fromTopIn" data-scroll="">
						...
						<div class="acc_con">
							<p>메뉴바 우측의 <a href="https://epiclounge.co.kr/v3/unrealfest2024/application_confirm.php" target="_blank">등록 확인</a>  페이지에서 직접 수정하실 수 있습니다.</p>
							<button type="button" class="acc_btn ">
							  <span class="faq_close">닫기</span>
							  </button>
						</div>
			...
			<div class="acc_list">
				  <div class="acc_item fromTopIn" data-scroll="">
					  ...
					  <div class="acc_con">
						  <p>오프라인은 오전 9시부터 <a href="https://epiclounge.co.kr/v3/unrealfest2024/application_check_in.php" target="_blank">등록 확인</a>후 입장이 가능하며, 세션룸 입장은 첫 세션 직전에 시작됩니다. 그 전까지 다양한 현장 이벤트에 참여하실 수 있습니다. 온라인은 각 일자 첫 세션 30분 전부터 시청 가능합니다.</p>
						  <button type="button" class="acc_btn ">
							<span class="faq_close">닫기</span>
							</button>
					  </div>                      
			...
			<div class="acc_list">
				  ...
				  <div class="acc_item fromTopIn" data-scroll="">
					  ...
					  <div class="acc_con">
						  <p>행사 종료 후 홈페이지 메뉴바 우측의 <a href="https://epiclounge.co.kr/v3/unrealfest2024/application_confirm.php" target="_blank">등록 확인</a>에서 본인 확인을 하시면 참가 확인증을 확인하고 다운로드하실 수 있습니다.</p>
						  <button type="button" class="acc_btn ">
							<span class="faq_close">닫기</span>
							</button>
					  </div>
				  ...
				  <div class="acc_item fromTopIn" data-scroll="">
					  ...
					  <div class="acc_con">
						  <p><a href="https://www.inicis.com/blog/archives/category/cs" target="_blank">이니시스 고객센터</a>로 문의해 주세요. 결제 오류 외의 문의는 <a href="tel:023263701" target="_blank">언리얼 페스트 사무국 전화</a> 또는 <a href="mailto:info@epiclounge.co.kr" target="_blank">이메일</a>로 연락해 주시기 바랍니다. 운영시간은 오전 10시~오후5시(점심시간 12시~1시 제외)입니다.</p>
						  <button type="button" class="acc_btn ">
							<span class="faq_close">닫기</span>
							</button>
					  </div>
				  ...
				  <div class="acc_item fromTopIn" data-scroll="">
					  ...
					  <div class="acc_con">
						  <p>메뉴바 우측의 <a href="https://epiclounge.co.kr/v3/unrealfest2024/application_confirm.php" target="_blank">등록 확인</a> 페이지에서 직접 결제 취소하실 수 있습니다. 환불은 8월 24일(일) 오전 9시까지 취소한 경우에만 가능하며, 최대 5일 이내 전액 환불됩니다. 단, 얼리버드 티켓은 해당 기간 이후에는 취소가 불가능합니다.</p>
						  <button type="button" class="acc_btn ">
							<span class="faq_close">닫기</span>
							</button>
					  </div>
