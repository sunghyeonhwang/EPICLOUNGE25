...
<html lang="kr" dir="ltr">
  ...
  <head>
	...
	<!-- Meta Tags-->
	<meta name="description" content="언리얼 페스트 서울 2025">
  ...
  <link rel="shortcut icon" href="https://unrealsummit16.cafe24.com/2025/ufest25/images/favicon-light.svg">
  ...
  <!-- Template Favicon & Icons End -->
	...
	<meta property="og:site_name" content="언리얼 페스트 서울 2025">
	<meta property="og:type" content="website">
	<meta property="og:title" content="언리얼 페스트 서울 2025">
  <meta property="og:description" content="언리얼 페스트는 언리얼 엔진과 에픽 에코시스템의 최신 기술, 그리고 다양한 산업에서의 혁신적인 리얼타임 3D 인터랙티브 제작 경험을 공유하는 에픽게임즈의 대표 연례 행사입니다. 오는 8월 25일(월)부터 26일(화)까지 양일간 열리는 이번 행사에서는 게임(프로그래밍/아트), 미디어 & 엔터테인먼트, 제조 및 시뮬레이션 등 다양한 산업별 트랙을 통해 총 38개의 세션이 진행됩니다." />
	<meta property="og:url" content="https://epiclounge.co.kr/unrealfest2025/index.php">
	<meta property="og:image" content="https://unrealsummit16.cafe24.com/2025/ufest25/unrealfest2025_key.jpg">
  ...
  <link rel="stylesheet" href="https://epiclounge.co.kr/v3/resource/css/common.css">
...
<script src="/v3/resource/js/common.js"></script>
  ...
  <link rel="stylesheet" href="/unrealfest2025/css/main_update_0723.css">
  </head>
...
<header id="header">
	<div class="wrap">
		<h1 class="logo"><a class="logo_img" href="/index_ufs25.php"><img src="/resource/images/common/logo.svg" /></a></h1>
...
<div id="lnb">
		...
		<h1 class="m_logo"><a class="logo_img" href="/index_ufs25.php"><img src="/resource/images/common/foot_logo.svg" /></a></h1>
  ...
  <ul class="top1menu clearfix">
	<li class="depth1"><a href="https://epiclounge.co.kr/unrealfest2025/" target="_self" class="tit depth1_ti"><span style="background: linear-gradient(90deg, #2D42DD 0%, #AF47F6 100%);
	background-clip: text;
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;">언리얼 페스트 서울 2025</span></a></li> 
    ...
    <li class="depth1"> <a href="/contents/event_list.php?category=커뮤니티 이벤트" target="_self" class="tit depth1_ti"><span>이벤트</span></a><div>
            <div class="menu_bg clearfix"> 
					...
					<!-- <strong><a href="https://epiclounge.co.kr/unrealfest24.php" target="_blank" class="tit02" style="color:#00C2E8; font-weight: 800;">언리얼 페스트 2024 서울</a></strong> -->
						<ul class="depth2">
							<!-- <li class="tit02_2_1"><a href="https://epiclounge.co.kr/unrealfest25_speaker.php" target="_blank" class="tit02" style="color:#00C2E8; font-weight: 800;">언리얼 페스트 서울 2025 </a></li> -->
    ...
    <li class="depth1"> <a href="/contents/replay.php" target="_self" class="tit depth1_ti"><span>리소스</span></a><div>
            <div class="menu_bg clearfix">  
					<div class="lnb_title_box">
						...
						<span class="text">언리얼 서밋, 웨비나, 테크토크, 무료 콘텐츠 등<br /> 다양한 리소스를 활용해 보세요.</span>
					</div>
					...
					<div class="lnb_menu_box">
						...
						<ul class="depth2">
							...
							<br><!--<li class="tit02_3_4"><a href="https://dev.epicgames.com/community/" target="_blank" class="tit02">DEV 커뮤니티</a><i class="fas fa-external-link-alt"></i></li>-->
						</ul>
					</div>
					<div class="lnb_banner">
		<?
