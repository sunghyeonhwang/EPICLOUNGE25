...
<div class="event_wrap">
	...
	<div id="event_cont_2">
		<div class="wrap">
            ...
            <ul>
					<li><button class="filter_reset_btn" type="button">ALL</button></li>
                	<li><input type="checkbox" id="pop_cate_2" name="pop_cate_2" class="" /><label for="pop_cate_2" class="pop_cate part_2">공통</label></li>
			...
			<div class="ticket_buy_box fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<div class="ticket_offline ticket_box">
					<div class="text_box">
						...
						<p class="text_3">기간: ~7/23(수)까지</p>
						<a href="application_step12.php" >등록하기</a>
					</div>
				</div>
	...
	<div class="pop_inner">
		<div class="pop_scroll">
			...
			<div class="sns_share_btn">
				...
				<a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index2.php?popidx=4'), 'facebook-share-dialog', 'width=626,height=436'); return false;"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon1.svg"></a><!-- 페이스북 -->
				<a href="#" onclick="window.open('https://twitter.com/intent/tweet?text=' + encodeURIComponent('언리얼 페스트 서울 2025 - 세션 정보') + '&amp;url=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index2.php?popidx=4'), 'twitter-share-dialog', 'width=550,height=420'); return false;"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon2.svg"></a><!-- 트위터 -->
				
				<!--<a href="#"
				   onclick="window.open('https://www.instagram.com/sharer.php?u=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index2.php?popidx=4'), 'instagram-share-dialog', 'width=626,height=436'); return false;"><img
							src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon3.svg"/></a>-->
				<a href="#" onclick="navigator.clipboard.writeText('https://epiclounge.co.kr/v3/unrealfest2025/index2.php?popidx=4').then(() =&gt; alert('링크가 복사되었습니다.')); return false;"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon4.svg"></a><!-- 링크 -->
			</div>
			<button class="inner_close">
				<span>CLOSE</span>
			</button>
					...
					<div class="owner_wrap">
						...
						<div class="owner">
							<div class="owner_name">
								...
								<!-- 발표자 이름 -->
								<!-- 발표자 직업 -->
								<span>General Manager of Unreal Enigne Ecosystem, Epic Games</span>
								<!-- 발표자 직업 -->
							</div>
...
<script>
	$(function() {
		...
		$('.filter_reset_btn').on('click', function() {
			// 모든 체크박스 해제
			$('.program_filter input[type="checkbox"]').prop('checked', false);
			
			// 필터링된 항목들 모두 다시 보이게 하기
			$('.program_table .program_item, .program_table tr, .program_table li, [data-filter-item]').show().removeClass('hidden filtered-out');
			
			// 흐릿하게 된 항목들 원상복구
			$('.program_table .program_item, .program_table tr, .program_table li, [data-filter-item]').css({
				'opacity': '1',
				'filter': 'none',
				'pointer-events': 'auto'
			}).removeClass('dimmed filtered inactive');
			
			// 필터 카운트가 있다면 초기화
			$('.filter_count, .result_count').text('');
			
			// 체크박스 change 이벤트 트리거 (기존 필터링 로직 호출)
			$('.program_filter input[type="checkbox"]').first().trigger('change');
