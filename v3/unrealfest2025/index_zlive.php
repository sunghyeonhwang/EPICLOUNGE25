...
include_once "member_header_update3.php";
?>
...
<div id="sns_fixed">
	...
	<a href="#"
	   onclick="window.open('https://twitter.com/intent/tweet?text=' + encodeURIComponent('언리얼 페스트 서울 2025 - 세션 정보') + '&url=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/'), 'twitter-share-dialog', 'width=550,height=420'); return false;"><img
				...
				<!--
	<a href="#"
	   onclick="window.open('https://www.instagram.com/sharer.php?u=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index.php'), 'instagram-share-dialog', 'width=626,height=436'); return false;"><img
				src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon3.svg"/></a> -->
	<a href="#"
	   onclick="navigator.clipboard.writeText('https://epiclounge.co.kr/v3/unrealfest2025/index.php').then(() => alert('링크가 복사되었습니다.')); return false;"><img
...
<div class="event_wrap">
	<div id="event_visual">
		...
		<div class="visual_text">
			...
			<span class="text_2"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/main_vi_text2.svg" alt="로고 이미지" /></span> -->
			<span class="text_1"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/main_vi_text1_live.svg" alt="로고 이미지" /></span>
			<span class="text_2"><a href="https://epiclounge.co.kr/unrealfest2025/application_check_in.php" target="_blank"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/main_vi_text2_live.svg" alt="로고 이미지" /></a></span>
		</div>
	</div>
	...
	<div id="event_cont_2">
		<div class="wrap">
			...
			<div class="date_header fromTopIn" data-scroll="">
				...
				<a href="https://unrealsummit16.cafe24.com/2025/ufest25/Unrealfest2025_Agenda_pdfv2.pdf" target="_blank">
					<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/update_time.svg" />
					전체 세션 확인하기
				</a> 
			</div>
			<div class="program_filter" data-filter-target=".program_table">

			<ul>
				<li><input type="checkbox" id="pop_cate_all" name="pop_cate_all" class="" />
					<label for="pop_cate_all" class="pop_cate part_all">ALL</label>
				</li>
				<li><input type="checkbox" id="pop_cate_2" name="pop_cate_2" class="" />
					<label for="pop_cate_2" class="pop_cate part_2">공통</label>
				</li>
				<li><input type="checkbox" id="pop_cate_15" name="pop_cate_15" /><label for="pop_cate_15" class="pop_cate part_15">프로그래밍</label></li>
					<li><input type="checkbox" id="pop_cate_16" name="pop_cate_16" /><label for="pop_cate_16" class="pop_cate part_16">비주얼아트</label></li>
					<li><input type="checkbox" id="pop_cate_17" name="pop_cate_17" /><label for="pop_cate_17" class="pop_cate part_17">기획</label></li>
					<li><input type="checkbox" id="pop_cate_7" name="pop_cate_7" /><label for="pop_cate_7" class="pop_cate part_7">게임</label></li>
					<li><input type="checkbox" id="pop_cate_8" name="pop_cate_8" /><label for="pop_cate_8" class="pop_cate part_8">프로덕션</label></li>
					<li><input type="checkbox" id="pop_cate_4" name="pop_cate_4" /><label for="pop_cate_4" class="pop_cate part_4">영화&TV</label></li>
					<li><input type="checkbox" id="pop_cate_6" name="pop_cate_6" /><label for="pop_cate_6" class="pop_cate part_6">방송&라이브이벤트</label></li>
					<li><input type="checkbox" id="pop_cate_14" name="pop_cate_14" /><label for="pop_cate_14" class="pop_cate part_14">XR</label></li>
					<li><input type="checkbox" id="pop_cate_9" name="pop_cate_9" /><label for="pop_cate_9" class="pop_cate part_9">애니메이션</label></li>
					<li><input type="checkbox" id="pop_cate_10" name="pop_cate_10" /><label for="pop_cate_10" class="pop_cate part_10">디지털트윈</label></li>
					<li><input type="checkbox" id="pop_cate_11" name="pop_cate_11" /><label for="pop_cate_11" class="pop_cate part_11">디지털휴먼</label></li>
					<li><input type="checkbox" id="pop_cate_12" name="pop_cate_12" /><label for="pop_cate_12" class="pop_cate part_12">버추얼프로덕션</label></li>
					<li><input type="checkbox" id="pop_cate_13" name="pop_cate_13" /><label for="pop_cate_13" class="pop_cate part_13">시뮬레이션</label></li>
					<li><input type="checkbox" id="pop_cate_1" name="pop_cate_1" /><label for="pop_cate_1" class="pop_cate part_1">자동차</label></li>
					<li><input type="checkbox" id="pop_level_1" name="pop_level_1" /><label for="pop_level_1" class="pop_level level_1">초급</label></li>
					<li><input type="checkbox" id="pop_level_2" name="pop_level_2" /><label for="pop_level_2" class="pop_level level_2">중급</label></li>
					<li><input type="checkbox" id="pop_level_3" name="pop_level_3" /><label for="pop_level_3" class="pop_level level_3">고급</label></li>
				</ul>
			</div>
					...
					<colgroup>
						...
						<thead>
							<tr>
								...
								<th scope="col" class="th_2"><span>게임: 아트</span></th>
								<th scope="col" class="th_3"><span>게임: 프로그래밍</span></th>
								<th scope="col" class="th_4"><span>미디어 & 엔터테인먼트</span></th>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3" class=" text_col_3 text_left big_td">
									...
									<span class="text_info">Bill Clifford</span>, <span style="font-weight: 400;">General Manager of Unreal Engine Ecosystem, Epic Games</span>
									</button>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="time_td"><span>18:20</span></td>
				...
				<div class="program_content">
					...
					<colgroup>
						...
						<thead>
							<tr>
								<th scope="col" class="th_1"><span>시간</span></th>
								<th scope="col" class="th_2"><span>제조 및 시뮬레이션</span></th>
								<th scope="col" class="th_3"><span>게임</span></th>
								<th scope="col" class="th_4"><span>미디어 & 엔터테인먼트</span></th>
						...
						<tbody>
							...
							<tr>
								<td class="time_td"><span>13:00</span></td>
								<td class="sm_td">
									<? xls_loader_cel(27,3);?>
								</td>
		...
		<div class="wrap">
			...
			<div class="ticket_buy_box fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<div class="ticket_offline ticket_box">
					<div class="text_box">
						<h3 class="h3">유료 티켓</h3>
						
						<p class="text_1">	
							<strong>오프라인</strong>
							<span></span>
						</p>
						<!-- <p class="text_2">오프라인</p> -->
						 <p class="text_3"><span style="color:#0AF3D9; font-size: 44px;">(+온라인)</span></p> 
						<a href="javascript:alert('오프라인 등록이 마감되었습니다. 온라인 무료 등록하세요.')" onfocus="this.blur()">등록 마감</a>
					</div>
				</div>
	
				<div class="ticket_online ticket_box">
					<div class="text_box">
						<h3 class="h3">무료 티켓</h3>
						<p class="text_1"><strong>온라인</strong></p>
						<!-- <p class="text_2">온라인</p> -->
						<p class="text_3"><span style="color: rgb(255, 200, 0); font-size: 18px; padding-top: 10px">(일부 세션 중계 및 Q&amp;A 제외)</span></p>
						<a href="application_step1_online.php" target="_blank" >무료 등록하기</a>
					</div>
				</div>
			</div>		
	...
	<div id="event_cont_4">
		<div class="wrap">
			...
			<!-- 골드 스폰서 -->
			<div class="sponsor_category fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
				<h4 class="sponsor_title">골드 스폰서</h4>
				<div class="sponsor_box1">
			...
			<!-- 실버 스폰서 -->
					<div class="sponsor_category fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
						<h4 class="sponsor_title2">실버 스폰서</h4>
						<div class="sponsor_box2">
							<p class="sp_img">
			...
			<div class="event_box_list no_pd">
				<div class="qr_event_box1 qr_event_box fromTopIn" data-scroll="toggle(.fromTopIn, .fromTopOut) once">
					...
					<div class="text_box">
						...
						<p class="list_box">
							<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/event_t2_v2.png">
							<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/event_t2_v1.png">
						</p>
					</div>
				</div>
				...
				<div class="qr_event_box2 fromTopIn" data-scroll="">
					...
					<div class="qr_event_box2_2 qr_event_box">
						...
						<div class="text_box">
							<h4>스탬프 투어</h4>
							<p class="text_1">부스 체험하고 한정판 굿즈 받자!</p>
								<p class="text_2">&nbsp;</p>
				...
				<div class="qr_event_box2 fromTopIn" data-scroll="">
					<div class="qr_event_box2_3 qr_event_box">
						...
						<div class="text_box">
							...
							<p class="list_box">
								<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/off_event_img411_v2.png">
							</p>
						</div>
					</div>
					<div class="qr_event_box2_4 qr_event_box">
						...
						<div class="text_box">
							...
							<p class="list_box">
								<img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/off_event_img412_v2.png">
							</p>
						</div>
					</div>
				</div>
			...
			<div class="acc_list">
				<div class="acc_item  fromTopIn " data-scroll="">
				  ...
				  <div class="acc_item  fromTopIn " data-scroll="">
					  ...
					  <div class="acc_con">
						  <p>언리얼 페스트 서울 2025는 8월 25일~26일 양일간 오프라인과 온라인으로 진행됩니다.<br />오프라인 등록은 유료이며, 원하는 일자별 세션 참석, 한정판 굿즈 수령, Q&A, 부스 체험 등 다양한 현장 프로그램에 참여하실 수 있습니다. 단, 한정 수량으로 조기 마감될 수 있으니 빠른 등록을 권장합니다.<br />온라인 등록은 무료로, 장소에 관계없이 세션 시청이 가능하며, 오프라인 등록이 마감된 경우에도 이용할 수 있습니다. 단, 발표자 동의 및 송출 환경에 따라 일부 세션은 중계되지 않을 수 있고, Q&amp;A는 제외됩니다.</p>
						  <button type="button" class="acc_btn ">
						  <span class="faq_close">닫기</span>
						  </button>
					  </div>
					...
					<div class="acc_item fromTopIn" data-scroll="">
						...
						<div class="acc_con">
							<p>오프라인 등록이 마감된 경우, 온라인 무료 등록을 통해 세션을 시청해 주세요. 단, 일부 세션은 중계되지 않을 수 있고, Q&amp;A는 제외됩니다.</p>
							<button type="button" class="acc_btn ">
							  <span class="faq_close">닫기</span>
							  </button>
						</div>
			...
			<div class="pop_inner">
				<div class="pop_scroll">
					...
					<div class="sns_share_btn">
						...
						<a href="#"
						   onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index.php?popidx=<?=$i?>'), 'facebook-share-dialog', 'width=626,height=436'); return false;"><img
									src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon1.svg"/></a><!-- 페이스북 -->
						<a href="#"
						   onclick="window.open('https://twitter.com/intent/tweet?text=' + encodeURIComponent('언리얼 페스트 서울 2025 - 세션 정보') + '&url=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index.php?popidx=<?= $i ?>'), 'twitter-share-dialog', 'width=550,height=420'); return false;"><img
									src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon2.svg"/></a><!-- 트위터 -->
						
						<!--<a href="#"
						   onclick="window.open('https://www.instagram.com/sharer.php?u=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index.php?popidx=<?=$i?>'), 'instagram-share-dialog', 'width=626,height=436'); return false;"><img
									src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon3.svg"/></a>-->
						<a href="#"
						   onclick="navigator.clipboard.writeText('https://epiclounge.co.kr/v3/unrealfest2025/index.php?popidx=<?=$i?>').then(() => alert('링크가 복사되었습니다.')); return false;"><img
									src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon4.svg"/></a><!-- 링크 -->
					</div>
...
<div class="pop pop_target_pop_1_1 keynot_pop">
	<button type="button" class="close">닫기</button>
	<div class="pop_inner">
		<div class="pop_scroll">
			<div class="pop_title">
				<!-- 날짜는 하드코딩 -->
				<span class="date">Day 1. 8월 25일(월)<span class="divider">ㅣ</span>11:10 ~ 11:25</span> <span class="cal_btn"> <a href="https://calendar.google.com/calendar/u/0/r/eventedit?text=언리얼페스트+서울+2025-+Day+1+TRACK+ALL
				+-+키노트1&dates=20250825T111000/20250825T112500&details=Tim Sweeney, Epic Games" title="새창" target="_blank">캘린더 추가하기</a></span>
				<!-- 날짜는 하드코딩 -->
				<!-- 제목은 땡겨옴 -->
				<h2>키노트 1 </h2>
				<!-- 제목은 땡겨옴 -->
			...
			<div class="pop_con_wrap">
				<div class="pop_con">
					...
					<div class="owner_wrap">
						<!-- 출연자 사진위치 -->
						<div class="img" style="background-image:url('/v3/unrealfest2025/images/TimSweeney.png')"></div>
						<!-- 출연자 사진위치 -->
						<div class="owner">
							<div class="owner_name">
								<!-- 발표자 이름 -->
								<strong>Tim Sweeney</strong>
								<!-- 발표자 이름 -->
								<!-- 발표자 직업 -->
								<span>Founder & CEO, Epic Games</span>
								<!-- 발표자 직업 -->
							</div>
					...
					<div class="text_box">
						<div class="title">세션소개</div>
						<div class="text">업계의 주요 트렌드, 언리얼 엔진 개발자를 위한 새로운 기회, 그리고 에픽이 모든 크리에이터를 위한 리얼타임 3D 오픈 에코시스템을 어떻게 구축해 나가고 있는지에 대한 인사이트를 공유합니다.</div>
					</div>
				</div>
			</div>
			<div class="sns_share_btn">
				
				<a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index.php?popidx=4'), 'facebook-share-dialog', 'width=626,height=436'); return false;"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon1.svg"></a><!-- 페이스북 -->
				<a href="#" onclick="window.open('https://twitter.com/intent/tweet?text=' + encodeURIComponent('언리얼 페스트 서울 2025 - 세션 정보') + '&amp;url=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index.php?popidx=4'), 'twitter-share-dialog', 'width=550,height=420'); return false;"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon2.svg"></a><!-- 트위터 -->
				
				<!--<a href="#"
				   onclick="window.open('https://www.instagram.com/sharer.php?u=' + encodeURIComponent('https://epiclounge.co.kr/v3/unrealfest2025/index.php?popidx=4'), 'instagram-share-dialog', 'width=626,height=436'); return false;"><img
							src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon3.svg"/></a>-->
				<a href="#" onclick="navigator.clipboard.writeText('https://epiclounge.co.kr/v3/unrealfest2025/index.php?popidx=4').then(() =&gt; alert('링크가 복사되었습니다.')); return false;"><img src="https://unrealsummit16.cafe24.com/2025/ufest25/images/link_icon4.svg"></a><!-- 링크 -->
			</div>
			<button class="inner_close">
				<span>CLOSE</span>
			</button>
...
<div class="pop pop_target_pop_1_2 keynot_pop">
	<button type="button" class="close">닫기</button>
	<div class="pop_inner">
		<div class="pop_scroll">
			<div class="pop_title">
				<!-- 날짜는 하드코딩 -->
				<span class="date">Day 1. 8월 25일(월)<span class="divider">ㅣ</span>11:25 ~ 11:40</span> <span class="cal_btn"> <a href="https://calendar.google.com/calendar/u/0/r/eventedit?text=언리얼페스트+서울+2025-+Day+1+TRACK+ALL
				+-+키노트2&dates=20250825T112500/20250825T114000&details=Bill Clifford, Epic Games" title="새창" target="_blank">캘린더 추가하기</a></span>
				<!-- 날짜는 하드코딩 -->
				<!-- 제목은 땡겨옴 -->
				<h2>키노트 2</h2>
				<!-- 제목은 땡겨옴 -->
			...
			<div class="pop_con_wrap">
				<div class="pop_con">
					...
					<div class="owner_wrap">
						<!-- 출연자 사진위치 -->
						<div class="img" style="background-image:url('/v3/unrealfest2025/images/Billclifford.png')"></div>
						<!-- 출연자 사진위치 -->
						<div class="owner">
							<div class="owner_name">
								<!-- 발표자 이름 -->
								<strong>Bill Clifford</strong>
								<!-- 발표자 이름 -->
								<!-- 발표자 직업 -->
								<span>General Manager of Unreal Engine Ecosystem, Epic Games</span>
								<!-- 발표자 직업 -->
							</div>
					...
					<div class="text_box">
						<div class="title">세션소개</div>
						<div class="text">게임은 물론, 버추얼 프로덕션, 자동차, 패션 등 다양한 산업 분야에서 크리에이터들이 언리얼 엔진을 활용해 창의적·기술적 한계를 어떻게 뛰어넘고 있는지를 소개합니다. 또한, 신규 툴, 커뮤니티의 확장과 함께 진화하는 에코시스템의 미래를 살펴봅니다.</div>
					</div>
				</div>
			</div>
			<div class="sns_share_btn">
...
<div class="pop pop_target_pop_1_3 keynot_pop">
	<button type="button" class="close">닫기</button>
	<div class="pop_inner">
		<div class="pop_scroll">
			<div class="pop_title">
				<!-- 날짜는 하드코딩 -->
				<span class="date">Day 1. 8월 25일(월)<span class="divider">ㅣ</span>11:40 ~ 12:00</span> <span class="cal_btn"> <a href="https://calendar.google.com/calendar/u/0/r/eventedit?text=언리얼페스트+서울+2025-+Day+1+TRACK+ALL
				+-+키노트3&dates=20250825T114000/20250825T120000&details=Marcus Wassmer, Epic Games" title="새창" target="_blank">캘린더 추가하기</a></span>
				<!-- 날짜는 하드코딩 -->
				<!-- 제목은 땡겨옴 -->
				<h2>키노트 3</h2>
				<!-- 제목은 땡겨옴 -->
			...
			<div class="pop_con_wrap">
				<div class="pop_con">
					...
					<div class="owner_wrap">
						<!-- 출연자 사진위치 -->
						<div class="img" style="background-image:url('/v3/unrealfest2025/images/marcuswassmer.png')"></div>
						<!-- 출연자 사진위치 -->
						<div class="owner">
							<div class="owner_name">
								<!-- 발표자 이름 -->
								<strong>Marcus Wassmer</strong>
								<!-- 발표자 이름 -->
								<!-- 발표자 직업 -->
								<span>EVP of Engineering, Epic Games</span>
								<!-- 발표자 직업 -->
							</div>
					...
					<div class="text_box">
						<div class="title">세션소개</div>
						<div class="text">최근 언리얼 엔진의 업데이트 내용을 되돌아보고, 향후 로드맵을 공유합니다. 언리얼 엔진 5.7 및 핵심 기능 향상, 그리고 전반적인 전략 방향을 통해 앞으로의 개발 계획 수립에 도움이 될 실질적인 인사이트를 제공할 예정입니다.</div>
					</div>
				</div>
			</div>
			<div class="sns_share_btn">
...
// Add click handler for category checkboxes 
			$('.program_filter input[type="checkbox"]').on('change', function () {
				// Handle pop_cate_all checkbox
				if ($(this).attr('id') === 'pop_cate_all' && $(this).is(':checked')) {
					// Uncheck all other checkboxes
					$('.program_filter input[type="checkbox"]').not(this).prop('checked', false);
					// Show all cells
					$('.program_table td:not(.time_td)').css('opacity', '1');
					return;
				}

				// If another checkbox is checked, uncheck pop_cate_all
				if ($(this).attr('id') !== 'pop_cate_all') {
					$('#pop_cate_all').prop('checked', false);
				}

				var checkedClasses = $('.program_filter input[type="checkbox"]:checked')
					.map(function () {
						return $(this).next('label').attr('class').split(' ')[1];
					}).get();

				// Show all table cells with opacity 1 if no checkboxes selected
				if (checkedClasses.length === 0) {
					$('.program_table td:not(.time_td)').css('opacity', '1');
					return;
				}

				// Filter table cells based on selected categories
				$('.program_table td:not(.time_td)').each(function () {
					var $td = $(this);
					var $spans = $td.find('span');
					var hasMatchingClass = false;

					$spans.each(function () {
						var spanClassList = ($(this).attr('class') || '').split(' ');
						checkedClasses.forEach(function (checkedClass) {
							if (spanClassList.indexOf(checkedClass) > -1) {
								hasMatchingClass = true;
							}
						});
					});

					if ($td.hasClass('time_td') || $td.hasClass('text_center') || $td.hasClass('last_pre')) {
						$td.css('opacity', '1');
					} else {
						$td.css('opacity', hasMatchingClass ? '1' : '0.3');
					}
				});
			});
		});
