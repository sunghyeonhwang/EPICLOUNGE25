...
sql_query("UPDATE cb_unreal_2025_event2_apply SET apply_temp_yn = 'N',apply_pay_status=10,free_yn='N',pay_complete='Y' WHERE apply_no = '$apply_no'");
