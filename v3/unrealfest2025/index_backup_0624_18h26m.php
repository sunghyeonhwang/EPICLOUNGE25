						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3" class=" text_col_3 text_left big_td">
									<button type="button" data-btn-pop="pop_1_1" class="program_part">
							...
							<tr>
								...
								<td colspan="3" class=" text_col_3 text_left big_td">
									<button type="button" data-btn-pop="pop_1_2" class="program_part">
									<span class="cate">Keynote</span>
							...
							<tr>
								...
								<td colspan="3" class="big_td text_col_3 text_left">
									<button type="button" data-btn-pop="pop_1_3" class="program_part">
									<span class="cate">Keynote</span>
							...
							<tr>
								...
								<td class="sm_td">
                                    <!--<button type="button" data-tn-pop="pop_1_6" class="program_part">
                                        <span class="title_m">UE5.6에서 확 달라진 메타휴먼: 핵심 업데이트 알아보기</span>
                                        <span class="text_name_company"><span class="text_name">박성제</span><span class="text_company">에픽케임즈 코리아</span></span>
                                        <span class="text_option_list">
                                            <span class="pop_cate cate_2">비주얼아트</span>
                                            <span class="pop_level level_2">중급</span>
                                            <span class="pop_division division_1">통역</span>
                                        </span>
                                    </button>-->
                                    <? xls_loader_cel(3);?>
								</td>
							...
							<tr>
								<td class="sm_td">
									<button type="button" data-tn-pop="pop_1_4" class="program_part">
										<span class="title_m">에픽게임즈 스토어: 2025년 스토어 및 제품 업데이트</span>
										<span class="text_name_company"><span class="text_name">Kyle Billings</span><span class="text_company">Epic Games</span></span>
										<span class="text_option_list">
											<span class="pop_cate cate_1">프로그래밍</span>
											<!-- 프로그래밍은 cate_1, 비주얼아트는 2 미디어&엔터테인먼트는3 구글시트 c에 순서대로 숫자바뀌면됨-->
											<span class="pop_level level_1">초급</span>
											<!-- 초급은1 중급2 고급은3-->
											<span class="pop_division division_1">통역</span>
