      ...
      <div class="wrap">
	   ...
	   <div class="member_title_box">
		...
		<div class="team_add_box1">
			  ...
			  <div class="lr_box">
			  <div class="left_box">
					<h4 class="h4">필수 안내 사항</h4>
					<ul class="bu">
						<li>단체 등록은 15인 이상부터 가능합니다.</li>
						<li>참가자 정보(연락처, 이메일, 티켓 선택)를 정확히 입력해 주세요. 총 결제 금액 계산 및 각 참가자에게 쿠폰을 발송하는 데 필요합니다.</li>
						<li><em class="em_b_yellow">단체 결제는 개별 참가자의 등록을 의미하지 않습니다.</em></li>
						<li>각 참가자는 <em class="em_b_yellow">언리얼 페스트 홈페이지에서 쿠폰 번호와 등록 정보를 입력</em>해야 등록이 최종 완료됩니다.</li>
					</ul>	
			  </div>
			  <div class="right_box">
	...
	$('.add_btn').click(function () {
		...
		const newRow = `
			<tr>
				...
				<td><input type="text" class="intext type_email" name="team_member_mail[]"  id="team_member_mail_${newIndex}" placeholder="이메을을 정확히 입력해 주세요" /></td>
				<td>
