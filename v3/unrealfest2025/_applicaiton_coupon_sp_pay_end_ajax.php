...
sql_query("UPDATE cb_unreal_2025_event2_coupon_sponsor SET usage_date = NOW(), user_name = '{$temp_data["apply_user_name"]}', user_email = '{$temp_data["apply_user_email"]}', user_phone = '{$temp_data["apply_user_phone"]}' WHERE coupon_key = '{$temp_data["apply_coupon_no"]}'");
